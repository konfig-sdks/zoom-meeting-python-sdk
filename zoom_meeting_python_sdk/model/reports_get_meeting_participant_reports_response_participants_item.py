...
class ReportsGetMeetingParticipantReportsResponseParticipantsItem(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["bo_mtg_id"]) -> MetaOapg.properties.bo_mtg_id: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["customer_key", "duration", "failover", "id", "join_time", "leave_time", "name", "registrant_id", "status", "user_email", "user_id", "bo_mtg_id", "participant_user_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bo_mtg_id"]) -> typing.Union[MetaOapg.properties.bo_mtg_id, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["customer_key", "duration", "failover", "id", "join_time", "leave_time", "name", "registrant_id", "status", "user_email", "user_id", "bo_mtg_id", "participant_user_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        bo_mtg_id: typing.Union[MetaOapg.properties.bo_mtg_id, str, schemas.Unset] = schemas.unset,
    ...
    ) -> 'ReportsGetMeetingParticipantReportsResponseParticipantsItem':
