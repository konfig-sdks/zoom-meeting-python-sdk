...
class MeetingsListPastMeetingPollsResponseQuestionsItemQuestionDetailsItem(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["polling_id"]) -> MetaOapg.properties.polling_id: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["answer", "date_time", "polling_id", "question", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["polling_id"]) -> typing.Union[MetaOapg.properties.polling_id, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["answer", "date_time", "polling_id", "question", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        polling_id: typing.Union[MetaOapg.properties.polling_id, str, schemas.Unset] = schemas.unset,
    ...
    ) -> 'MeetingsListPastMeetingPollsResponseQuestionsItemQuestionDetailsItem':
