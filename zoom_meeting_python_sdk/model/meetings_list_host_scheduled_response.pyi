...
class MeetingsListHostScheduledResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def meetings() -> typing.Type['MeetingsListHostScheduledResponseMeetings']:
                return MeetingsListHostScheduledResponseMeetings
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meetings"]) -> 'MeetingsListHostScheduledResponseMeetings': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["next_page_token", "page_count", "page_number", "page_size", "total_records", "meetings", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meetings"]) -> typing.Union['MeetingsListHostScheduledResponseMeetings', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["next_page_token", "page_count", "page_number", "page_size", "total_records", "meetings", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        meetings: typing.Union['MeetingsListHostScheduledResponseMeetings', schemas.Unset] = schemas.unset,
