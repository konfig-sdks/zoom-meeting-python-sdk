...
class ArchivingMeetingFilesListResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def meetings() -> typing.Type['ArchivingMeetingFilesListResponseMeetings']:
                return ArchivingMeetingFilesListResponseMeetings
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meetings"]) -> 'ArchivingMeetingFilesListResponseMeetings': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["from", "meetings", "next_page_token", "page_size", "to", "total_records", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meetings"]) -> typing.Union['ArchivingMeetingFilesListResponseMeetings', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["from", "meetings", "next_page_token", "page_size", "to", "total_records", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        meetings: typing.Union['ArchivingMeetingFilesListResponseMeetings', schemas.Unset] = schemas.unset,
