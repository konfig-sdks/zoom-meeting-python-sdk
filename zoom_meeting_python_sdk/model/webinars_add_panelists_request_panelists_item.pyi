...
class WebinarsAddPanelistsRequestPanelistsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "name", "virtual_background_id", "name_tag_id", "name_tag_name", "name_tag_pronouns", "name_tag_description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "name", "virtual_background_id", "name_tag_id", "name_tag_name", "name_tag_pronouns", "name_tag_description", ], str]):
    ...
    ) -> 'WebinarsAddPanelistsRequestPanelistsItem':
