...
class CloudRecordingListRegistrantsResponseRegistrantsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def custom_questions() -> typing.Type['CloudRecordingListRegistrantsResponseRegistrantsItemCustomQuestions']:
                return CloudRecordingListRegistrantsResponseRegistrantsItemCustomQuestions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["custom_questions"]) -> 'CloudRecordingListRegistrantsResponseRegistrantsItemCustomQuestions': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "first_name", "id", "address", "city", "comments", "country", "custom_questions", "industry", "job_title", "last_name", "no_of_employees", "org", "phone", "purchasing_time_frame", "role_in_purchase_process", "state", "status", "zip", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["custom_questions"]) -> typing.Union['CloudRecordingListRegistrantsResponseRegistrantsItemCustomQuestions', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "first_name", "id", "address", "city", "comments", "country", "custom_questions", "industry", "job_title", "last_name", "no_of_employees", "org", "phone", "purchasing_time_frame", "role_in_purchase_process", "state", "status", "zip", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        custom_questions: typing.Union['CloudRecordingListRegistrantsResponseRegistrantsItemCustomQuestions', schemas.Unset] = schemas.unset,
    ...
    ) -> 'CloudRecordingListRegistrantsResponseRegistrantsItem':
