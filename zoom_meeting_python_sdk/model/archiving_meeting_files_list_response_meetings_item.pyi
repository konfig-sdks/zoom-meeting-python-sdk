...
class ArchivingMeetingFilesListResponseMeetingsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def archive_files() -> typing.Type['ArchivingMeetingFilesListResponseMeetingsItemArchiveFiles']:
                return ArchivingMeetingFilesListResponseMeetingsItemArchiveFiles
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["archive_files"]) -> 'ArchivingMeetingFilesListResponseMeetingsItemArchiveFiles': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["archive_files"]) -> 'ArchivingMeetingFilesListResponseMeetingsItemArchiveFiles': ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ArchivingMeetingFilesListResponseMeetingsItem':
        return super().__new__(
            cls,
            *args,
            timezone=timezone,
