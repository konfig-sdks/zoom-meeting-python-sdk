...
class ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def answer_details() -> typing.Type['ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItemAnswerDetails']:
                return ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItemAnswerDetails
            __annotations__ = {
                "answer": answer,
                "question": question,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["answer_details"]) -> 'ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItemAnswerDetails': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["answer_details"]) -> typing.Union['ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItemAnswerDetails', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        answer_details: typing.Union['ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItemAnswerDetails', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItem':
