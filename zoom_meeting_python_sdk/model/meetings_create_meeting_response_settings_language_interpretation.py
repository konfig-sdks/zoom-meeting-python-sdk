...
class MeetingsCreateMeetingResponseSettingsLanguageInterpretation(
    schemas.DictSchema
):
    """
...
**Note:** This feature is only available for certain Meeting add-on, Education, and Business and higher plans. If this feature is not enabled on the host's account, this setting will **not** be applied to the meeting.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def interpreters() -> typing.Type['MeetingsCreateMeetingResponseSettingsLanguageInterpretationInterpreters']:
                return MeetingsCreateMeetingResponseSettingsLanguageInterpretationInterpreters
            __annotations__ = {
                "enable": enable,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["interpreters"]) -> 'MeetingsCreateMeetingResponseSettingsLanguageInterpretationInterpreters': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["interpreters"]) -> typing.Union['MeetingsCreateMeetingResponseSettingsLanguageInterpretationInterpreters', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        interpreters: typing.Union['MeetingsCreateMeetingResponseSettingsLanguageInterpretationInterpreters', schemas.Unset] = schemas.unset,
