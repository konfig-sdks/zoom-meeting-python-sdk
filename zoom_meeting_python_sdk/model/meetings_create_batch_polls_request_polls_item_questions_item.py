...
class MeetingsCreateBatchPollsRequestPollsItemQuestionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def answers() -> typing.Type['MeetingsCreateBatchPollsRequestPollsItemQuestionsItemAnswers']:
                return MeetingsCreateBatchPollsRequestPollsItemQuestionsItemAnswers
            ...
            @staticmethod
            def prompts() -> typing.Type['MeetingsCreateBatchPollsRequestPollsItemQuestionsItemPrompts']:
                return MeetingsCreateBatchPollsRequestPollsItemQuestionsItemPrompts
            ...
            @staticmethod
            def right_answers() -> typing.Type['MeetingsCreateBatchPollsRequestPollsItemQuestionsItemRightAnswers']:
                return MeetingsCreateBatchPollsRequestPollsItemQuestionsItemRightAnswers
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["answers"]) -> 'MeetingsCreateBatchPollsRequestPollsItemQuestionsItemAnswers': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prompts"]) -> 'MeetingsCreateBatchPollsRequestPollsItemQuestionsItemPrompts': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["right_answers"]) -> 'MeetingsCreateBatchPollsRequestPollsItemQuestionsItemRightAnswers': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["answers"]) -> typing.Union['MeetingsCreateBatchPollsRequestPollsItemQuestionsItemAnswers', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prompts"]) -> typing.Union['MeetingsCreateBatchPollsRequestPollsItemQuestionsItemPrompts', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["right_answers"]) -> typing.Union['MeetingsCreateBatchPollsRequestPollsItemQuestionsItemRightAnswers', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        answers: typing.Union['MeetingsCreateBatchPollsRequestPollsItemQuestionsItemAnswers', schemas.Unset] = schemas.unset,
        case_sensitive: typing.Union[MetaOapg.properties.case_sensitive, bool, schemas.Unset] = schemas.unset,
        name: typing.Union[MetaOapg.properties.name, str, schemas.Unset] = schemas.unset,
        prompts: typing.Union['MeetingsCreateBatchPollsRequestPollsItemQuestionsItemPrompts', schemas.Unset] = schemas.unset,
        ...
        right_answers: typing.Union['MeetingsCreateBatchPollsRequestPollsItemQuestionsItemRightAnswers', schemas.Unset] = schemas.unset,
    ...
    ) -> 'MeetingsCreateBatchPollsRequestPollsItemQuestionsItem':
