...
class WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation(
    schemas.DictSchema
):
    """
...
**Note:** If this feature is not enabled on the host's account, this setting will **not** be applied to the webinar.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def interpreters() -> typing.Type['WebinarsCreateWebinarRequestSettingsSignLanguageInterpretationInterpreters']:
                return WebinarsCreateWebinarRequestSettingsSignLanguageInterpretationInterpreters
            __annotations__ = {
                "enable": enable,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["interpreters"]) -> 'WebinarsCreateWebinarRequestSettingsSignLanguageInterpretationInterpreters': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["interpreters"]) -> typing.Union['WebinarsCreateWebinarRequestSettingsSignLanguageInterpretationInterpreters', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        interpreters: typing.Union['WebinarsCreateWebinarRequestSettingsSignLanguageInterpretationInterpreters', schemas.Unset] = schemas.unset,
