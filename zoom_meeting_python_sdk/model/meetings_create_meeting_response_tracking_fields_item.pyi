...
class MeetingsCreateMeetingResponseTrackingFieldsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["field", "value", "visible", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["field", "value", "visible", ], str]):
    ...
    ) -> 'MeetingsCreateMeetingResponseTrackingFieldsItem':
