...
class SipPhoneListResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def phones() -> typing.Type['SipPhoneListResponsePhones']:
                return SipPhoneListResponsePhones
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["phones"]) -> 'SipPhoneListResponsePhones': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["next_page_token", "page_count", "page_number", "page_size", "phones", "total_records", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["phones"]) -> typing.Union['SipPhoneListResponsePhones', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["next_page_token", "page_count", "page_number", "page_size", "phones", "total_records", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        phones: typing.Union['SipPhoneListResponsePhones', schemas.Unset] = schemas.unset,
