...
class MeetingsUpdateMeetingPollRequestQuestionsItemPromptsItemPromptRightAnswers(
    schemas.ListSchema
):
    """NOTE:
...
* For `rank_order` polls, you can only provide one correct answer.
    ...
    ) -> 'MeetingsUpdateMeetingPollRequestQuestionsItemPromptsItemPromptRightAnswers':
