...
class WebinarsCreateWebinarRequestSettings(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def attendees_and_panelists_reminder_email_notification() -> typing.Type['WebinarsCreateWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification']:
                return WebinarsCreateWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification
            ...
            @staticmethod
            def follow_up_absentees_email_notification() -> typing.Type['WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification']:
                return WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification
        
            @staticmethod
            def follow_up_attendees_email_notification() -> typing.Type['WebinarsCreateWebinarRequestSettingsFollowUpAttendeesEmailNotification']:
                return WebinarsCreateWebinarRequestSettingsFollowUpAttendeesEmailNotification
        
            @staticmethod
            def global_dial_in_countries() -> typing.Type['WebinarsCreateWebinarRequestSettingsGlobalDialInCountries']:
                return WebinarsCreateWebinarRequestSettingsGlobalDialInCountries
            hd_video = schemas.BoolSchema
            hd_video_for_attendees = schemas.BoolSchema
            host_video = schemas.BoolSchema
        
            @staticmethod
            def language_interpretation() -> typing.Type['WebinarsCreateWebinarRequestSettingsLanguageInterpretation']:
                return WebinarsCreateWebinarRequestSettingsLanguageInterpretation
        
            @staticmethod
            def sign_language_interpretation() -> typing.Type['WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation']:
                return WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation
            ...
            @staticmethod
            def question_and_answer() -> typing.Type['WebinarsCreateWebinarRequestSettingsQuestionAndAnswer']:
                return WebinarsCreateWebinarRequestSettingsQuestionAndAnswer
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["attendees_and_panelists_reminder_email_notification"]) -> 'WebinarsCreateWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["follow_up_absentees_email_notification"]) -> 'WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["follow_up_attendees_email_notification"]) -> 'WebinarsCreateWebinarRequestSettingsFollowUpAttendeesEmailNotification': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["global_dial_in_countries"]) -> 'WebinarsCreateWebinarRequestSettingsGlobalDialInCountries': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["language_interpretation"]) -> 'WebinarsCreateWebinarRequestSettingsLanguageInterpretation': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sign_language_interpretation"]) -> 'WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["question_and_answer"]) -> 'WebinarsCreateWebinarRequestSettingsQuestionAndAnswer': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["allow_multiple_devices", "alternative_hosts", "alternative_host_update_polls", "approval_type", "attendees_and_panelists_reminder_email_notification", "audio", "audio_conference_info", "authentication_domains", "authentication_option", "auto_recording", "close_registration", "contact_email", "contact_name", "email_language", "enforce_login", "enforce_login_domains", "follow_up_absentees_email_notification", "follow_up_attendees_email_notification", "global_dial_in_countries", "hd_video", "hd_video_for_attendees", "host_video", "language_interpretation", "sign_language_interpretation", "panelist_authentication", "meeting_authentication", "add_watermark", "add_audio_watermark", "on_demand", "panelists_invitation_email_notification", "panelists_video", "post_webinar_survey", "practice_session", "question_and_answer", "registrants_email_notification", "registrants_restrict_number", "registration_type", "send_1080p_video_to_attendees", "show_share_button", "survey_url", "enable_session_branding", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attendees_and_panelists_reminder_email_notification"]) -> typing.Union['WebinarsCreateWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["follow_up_absentees_email_notification"]) -> typing.Union['WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["follow_up_attendees_email_notification"]) -> typing.Union['WebinarsCreateWebinarRequestSettingsFollowUpAttendeesEmailNotification', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["global_dial_in_countries"]) -> typing.Union['WebinarsCreateWebinarRequestSettingsGlobalDialInCountries', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["language_interpretation"]) -> typing.Union['WebinarsCreateWebinarRequestSettingsLanguageInterpretation', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sign_language_interpretation"]) -> typing.Union['WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["question_and_answer"]) -> typing.Union['WebinarsCreateWebinarRequestSettingsQuestionAndAnswer', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        attendees_and_panelists_reminder_email_notification: typing.Union['WebinarsCreateWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification', schemas.Unset] = schemas.unset,
        ...
        follow_up_absentees_email_notification: typing.Union['WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification', schemas.Unset] = schemas.unset,
        follow_up_attendees_email_notification: typing.Union['WebinarsCreateWebinarRequestSettingsFollowUpAttendeesEmailNotification', schemas.Unset] = schemas.unset,
        global_dial_in_countries: typing.Union['WebinarsCreateWebinarRequestSettingsGlobalDialInCountries', schemas.Unset] = schemas.unset,
        ...
        language_interpretation: typing.Union['WebinarsCreateWebinarRequestSettingsLanguageInterpretation', schemas.Unset] = schemas.unset,
        sign_language_interpretation: typing.Union['WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation', schemas.Unset] = schemas.unset,
        ...
        question_and_answer: typing.Union['WebinarsCreateWebinarRequestSettingsQuestionAndAnswer', schemas.Unset] = schemas.unset,
