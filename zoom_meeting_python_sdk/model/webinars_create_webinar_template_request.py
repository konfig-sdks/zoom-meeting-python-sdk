...
class WebinarsCreateWebinarTemplateRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["webinar_id", "name", "save_recurrence", "overwrite", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["webinar_id", "name", "save_recurrence", "overwrite", ], str]):
