...
class WebinarsCreateInviteLinksResponseAttendeesItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["join_url", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["join_url", "name", ], str]):
    ...
    ) -> 'WebinarsCreateInviteLinksResponseAttendeesItem':
