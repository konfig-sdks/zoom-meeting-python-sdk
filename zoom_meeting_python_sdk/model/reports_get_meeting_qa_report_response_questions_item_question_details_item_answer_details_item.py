...
class ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItemAnswerDetailsItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItemAnswerDetailsItem':
