...
class MeetingsCreateMeetingResponseSettingsSignLanguageInterpretation(
    schemas.DictSchema
):
    """
...
**Note:** If this feature is not enabled on the host's account, this setting will **not** be applied to the meeting.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def interpreters() -> typing.Type['MeetingsCreateMeetingResponseSettingsSignLanguageInterpretationInterpreters']:
                return MeetingsCreateMeetingResponseSettingsSignLanguageInterpretationInterpreters
            __annotations__ = {
                "enable": enable,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["interpreters"]) -> 'MeetingsCreateMeetingResponseSettingsSignLanguageInterpretationInterpreters': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["interpreters"]) -> typing.Union['MeetingsCreateMeetingResponseSettingsSignLanguageInterpretationInterpreters', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        interpreters: typing.Union['MeetingsCreateMeetingResponseSettingsSignLanguageInterpretationInterpreters', schemas.Unset] = schemas.unset,
