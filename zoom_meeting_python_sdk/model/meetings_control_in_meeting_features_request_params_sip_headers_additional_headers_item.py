...
class MeetingsControlInMeetingFeaturesRequestParamsSipHeadersAdditionalHeadersItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'MeetingsControlInMeetingFeaturesRequestParamsSipHeadersAdditionalHeadersItem':
