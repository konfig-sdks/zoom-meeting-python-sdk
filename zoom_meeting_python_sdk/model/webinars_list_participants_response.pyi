...
class WebinarsListParticipantsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def participants() -> typing.Type['WebinarsListParticipantsResponseParticipants']:
                return WebinarsListParticipantsResponseParticipants
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["participants"]) -> 'WebinarsListParticipantsResponseParticipants': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["next_page_token", "page_count", "page_size", "participants", "total_records", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["participants"]) -> typing.Union['WebinarsListParticipantsResponseParticipants', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["next_page_token", "page_count", "page_size", "participants", "total_records", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        participants: typing.Union['WebinarsListParticipantsResponseParticipants', schemas.Unset] = schemas.unset,
