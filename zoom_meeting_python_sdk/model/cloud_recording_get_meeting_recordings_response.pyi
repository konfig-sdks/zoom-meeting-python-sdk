...
class CloudRecordingGetMeetingRecordingsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def recording_files() -> typing.Type['CloudRecordingGetMeetingRecordingsResponseRecordingFiles']:
                return CloudRecordingGetMeetingRecordingsResponseRecordingFiles
            download_access_token = schemas.StrSchema
            password = schemas.StrSchema
        
            @staticmethod
            def participant_audio_files() -> typing.Type['CloudRecordingGetMeetingRecordingsResponseParticipantAudioFiles']:
                return CloudRecordingGetMeetingRecordingsResponseParticipantAudioFiles
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["recording_files"]) -> 'CloudRecordingGetMeetingRecordingsResponseRecordingFiles': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["download_access_token"]) -> MetaOapg.properties.download_access_token: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["password"]) -> MetaOapg.properties.password: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["participant_audio_files"]) -> 'CloudRecordingGetMeetingRecordingsResponseParticipantAudioFiles': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_id", "duration", "host_id", "id", "recording_count", "start_time", "topic", "total_size", "type", "uuid", "recording_play_passcode", "recording_files", "download_access_token", "password", "participant_audio_files", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["recording_files"]) -> typing.Union['CloudRecordingGetMeetingRecordingsResponseRecordingFiles', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["download_access_token"]) -> typing.Union[MetaOapg.properties.download_access_token, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["password"]) -> typing.Union[MetaOapg.properties.password, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["participant_audio_files"]) -> typing.Union['CloudRecordingGetMeetingRecordingsResponseParticipantAudioFiles', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_id", "duration", "host_id", "id", "recording_count", "start_time", "topic", "total_size", "type", "uuid", "recording_play_passcode", "recording_files", "download_access_token", "password", "participant_audio_files", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        recording_files: typing.Union['CloudRecordingGetMeetingRecordingsResponseRecordingFiles', schemas.Unset] = schemas.unset,
        download_access_token: typing.Union[MetaOapg.properties.download_access_token, str, schemas.Unset] = schemas.unset,
        password: typing.Union[MetaOapg.properties.password, str, schemas.Unset] = schemas.unset,
        participant_audio_files: typing.Union['CloudRecordingGetMeetingRecordingsResponseParticipantAudioFiles', schemas.Unset] = schemas.unset,
