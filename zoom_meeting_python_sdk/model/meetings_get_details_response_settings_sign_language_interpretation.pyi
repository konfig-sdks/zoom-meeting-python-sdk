...
class MeetingsGetDetailsResponseSettingsSignLanguageInterpretation(
    schemas.DictSchema
):
    """
...
**Note:** If this feature is not enabled on the host's account, this setting will **not** be applied to the meeting.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def interpreters() -> typing.Type['MeetingsGetDetailsResponseSettingsSignLanguageInterpretationInterpreters']:
                return MeetingsGetDetailsResponseSettingsSignLanguageInterpretationInterpreters
            __annotations__ = {
                "enable": enable,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["interpreters"]) -> 'MeetingsGetDetailsResponseSettingsSignLanguageInterpretationInterpreters': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["interpreters"]) -> typing.Union['MeetingsGetDetailsResponseSettingsSignLanguageInterpretationInterpreters', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        interpreters: typing.Union['MeetingsGetDetailsResponseSettingsSignLanguageInterpretationInterpreters', schemas.Unset] = schemas.unset,
