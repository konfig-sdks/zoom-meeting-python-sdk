...
class CloudRecordingListRecordingsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def meetings() -> typing.Type['CloudRecordingListRecordingsResponseMeetings']:
                return CloudRecordingListRecordingsResponseMeetings
            __annotations__ = {
                "from": _from,
                "to": to,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meetings"]) -> 'CloudRecordingListRecordingsResponseMeetings': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["from", "to", "next_page_token", "page_count", "page_size", "total_records", "meetings", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meetings"]) -> typing.Union['CloudRecordingListRecordingsResponseMeetings', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["from", "to", "next_page_token", "page_count", "page_size", "total_records", "meetings", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        meetings: typing.Union['CloudRecordingListRecordingsResponseMeetings', schemas.Unset] = schemas.unset,
