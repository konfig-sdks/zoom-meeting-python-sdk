...
class WebinarsCreateWebinarResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def occurrences() -> typing.Type['WebinarsCreateWebinarResponseOccurrences']:
                return WebinarsCreateWebinarResponseOccurrences
            ...
            @staticmethod
            def recurrence() -> typing.Type['WebinarsCreateWebinarResponseRecurrence']:
                return WebinarsCreateWebinarResponseRecurrence
        
            @staticmethod
            def settings() -> typing.Type['WebinarsCreateWebinarResponseSettings']:
                return WebinarsCreateWebinarResponseSettings
            ...
            @staticmethod
            def tracking_fields() -> typing.Type['WebinarsCreateWebinarResponseTrackingFields']:
                return WebinarsCreateWebinarResponseTrackingFields
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["occurrences"]) -> 'WebinarsCreateWebinarResponseOccurrences': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["recurrence"]) -> 'WebinarsCreateWebinarResponseRecurrence': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["settings"]) -> 'WebinarsCreateWebinarResponseSettings': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tracking_fields"]) -> 'WebinarsCreateWebinarResponseTrackingFields': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["host_email", "host_id", "id", "registrants_confirmation_email", "template_id", "uuid", "agenda", "created_at", "duration", "join_url", "occurrences", "password", "encrypted_passcode", "h323_passcode", "recurrence", "settings", "start_time", "start_url", "timezone", "topic", "tracking_fields", "type", "is_simulive", "record_file_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["occurrences"]) -> typing.Union['WebinarsCreateWebinarResponseOccurrences', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["recurrence"]) -> typing.Union['WebinarsCreateWebinarResponseRecurrence', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["settings"]) -> typing.Union['WebinarsCreateWebinarResponseSettings', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tracking_fields"]) -> typing.Union['WebinarsCreateWebinarResponseTrackingFields', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        occurrences: typing.Union['WebinarsCreateWebinarResponseOccurrences', schemas.Unset] = schemas.unset,
        ...
        recurrence: typing.Union['WebinarsCreateWebinarResponseRecurrence', schemas.Unset] = schemas.unset,
        settings: typing.Union['WebinarsCreateWebinarResponseSettings', schemas.Unset] = schemas.unset,
        ...
        tracking_fields: typing.Union['WebinarsCreateWebinarResponseTrackingFields', schemas.Unset] = schemas.unset,
