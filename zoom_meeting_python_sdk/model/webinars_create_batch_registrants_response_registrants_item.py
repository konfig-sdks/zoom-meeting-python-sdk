...
class WebinarsCreateBatchRegistrantsResponseRegistrantsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "join_url", "registrant_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "join_url", "registrant_id", ], str]):
    ...
    ) -> 'WebinarsCreateBatchRegistrantsResponseRegistrantsItem':
