...
class MeetingsAddRegistrantResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def occurrences() -> typing.Type['MeetingsAddRegistrantResponseOccurrences']:
                return MeetingsAddRegistrantResponseOccurrences
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["occurrences"]) -> 'MeetingsAddRegistrantResponseOccurrences': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "join_url", "registrant_id", "start_time", "topic", "occurrences", "participant_pin_code", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["occurrences"]) -> typing.Union['MeetingsAddRegistrantResponseOccurrences', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "join_url", "registrant_id", "start_time", "topic", "occurrences", "participant_pin_code", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        occurrences: typing.Union['MeetingsAddRegistrantResponseOccurrences', schemas.Unset] = schemas.unset,
