...
class WebinarsGetSessionBrandingResponseVirtualBackgroundsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "is_default", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "is_default", ], str]):
    ...
    ) -> 'WebinarsGetSessionBrandingResponseVirtualBackgroundsItem':
