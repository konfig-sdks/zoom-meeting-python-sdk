...
class WebinarsListWebinarsResponseWebinarsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["agenda", "created_at", "duration", "host_id", "id", "join_url", "start_time", "timezone", "topic", "type", "uuid", "is_simulive", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["agenda", "created_at", "duration", "host_id", "id", "join_url", "start_time", "timezone", "topic", "type", "uuid", "is_simulive", ], str]):
    ...
    ) -> 'WebinarsListWebinarsResponseWebinarsItem':
