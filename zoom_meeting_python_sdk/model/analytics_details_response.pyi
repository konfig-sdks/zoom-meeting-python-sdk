...
class AnalyticsDetailsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def analytics_details() -> typing.Type['AnalyticsDetailsResponseAnalyticsDetails']:
                return AnalyticsDetailsResponseAnalyticsDetails
            __annotations__ = {
                "from": _from,
                "to": to,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["analytics_details"]) -> 'AnalyticsDetailsResponseAnalyticsDetails': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["from", "to", "next_page_token", "page_size", "total_records", "analytics_details", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["analytics_details"]) -> typing.Union['AnalyticsDetailsResponseAnalyticsDetails', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["from", "to", "next_page_token", "page_size", "total_records", "analytics_details", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        analytics_details: typing.Union['AnalyticsDetailsResponseAnalyticsDetails', schemas.Unset] = schemas.unset,
