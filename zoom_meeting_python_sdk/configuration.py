...
from zoom_meeting_python_sdk.exceptions_base import ApiValueError
from zoom_meeting_python_sdk.exceptions import ClientConfigurationError
...
conf = zoom_meeting_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.zoom.us/v2" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if openapi_authorization:
            self.api_key['openapi_authorization'] = openapi_authorization
        else:
            raise ClientConfigurationError('API Key "openapi_authorization" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("zoom_meeting_python_sdk")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'openapi_authorization' in self.api_key:
            auth['openapi_authorization'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
