...
from zoom_meeting_python_sdk.type.webinars_list_registrants_response_registrants_item_custom_questions import WebinarsListRegistrantsResponseRegistrantsItemCustomQuestions

class RequiredWebinarsListRegistrantsResponseRegistrantsItem(TypedDict):
...
class OptionalWebinarsListRegistrantsResponseRegistrantsItem(TypedDict, total=False):
    # Registrant ID.
    id: str
    ...
    custom_questions: WebinarsListRegistrantsResponseRegistrantsItemCustomQuestions
...
class WebinarsListRegistrantsResponseRegistrantsItem(RequiredWebinarsListRegistrantsResponseRegistrantsItem, OptionalWebinarsListRegistrantsResponseRegistrantsItem):
    pass
