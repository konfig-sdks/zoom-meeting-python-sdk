...
from zoom_meeting_python_sdk.type.meetings_get_meeting_survey_response_custom_survey_questions_item_answers import MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItemAnswers
from zoom_meeting_python_sdk.type.meetings_get_meeting_survey_response_custom_survey_questions_item_prompts import MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItemPrompts

class RequiredMeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItem(TypedDict):
    pass

class OptionalMeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItem(TypedDict, total=False):
    ...
    answers: MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItemAnswers

    prompts: MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItemPrompts
...
class MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItem(RequiredMeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItem, OptionalMeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItem):
    pass
