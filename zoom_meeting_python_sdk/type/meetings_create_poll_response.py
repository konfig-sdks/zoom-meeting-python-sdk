...
from zoom_meeting_python_sdk.type.meetings_create_poll_response_questions import MeetingsCreatePollResponseQuestions

class RequiredMeetingsCreatePollResponse(TypedDict):
    pass

class OptionalMeetingsCreatePollResponse(TypedDict, total=False):
    ...
    questions: MeetingsCreatePollResponseQuestions

class MeetingsCreatePollResponse(RequiredMeetingsCreatePollResponse, OptionalMeetingsCreatePollResponse):
    pass
