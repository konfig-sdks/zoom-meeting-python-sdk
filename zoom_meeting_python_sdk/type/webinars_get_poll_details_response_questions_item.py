...
from zoom_meeting_python_sdk.type.webinars_get_poll_details_response_questions_item_answers import WebinarsGetPollDetailsResponseQuestionsItemAnswers
from zoom_meeting_python_sdk.type.webinars_get_poll_details_response_questions_item_prompts import WebinarsGetPollDetailsResponseQuestionsItemPrompts
from zoom_meeting_python_sdk.type.webinars_get_poll_details_response_questions_item_right_answers import WebinarsGetPollDetailsResponseQuestionsItemRightAnswers

class RequiredWebinarsGetPollDetailsResponseQuestionsItem(TypedDict):
    pass

class OptionalWebinarsGetPollDetailsResponseQuestionsItem(TypedDict, total=False):
    ...
    answers: WebinarsGetPollDetailsResponseQuestionsItemAnswers
    ...
    prompts: WebinarsGetPollDetailsResponseQuestionsItemPrompts
    ...
    right_answers: WebinarsGetPollDetailsResponseQuestionsItemRightAnswers
...
class WebinarsGetPollDetailsResponseQuestionsItem(RequiredWebinarsGetPollDetailsResponseQuestionsItem, OptionalWebinarsGetPollDetailsResponseQuestionsItem):
    pass
