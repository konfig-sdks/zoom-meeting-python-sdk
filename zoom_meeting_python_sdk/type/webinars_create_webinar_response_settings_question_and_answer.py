...
class RequiredWebinarsCreateWebinarResponseSettingsQuestionAndAnswer(TypedDict):
    pass

class OptionalWebinarsCreateWebinarResponseSettingsQuestionAndAnswer(TypedDict, total=False):
...
class WebinarsCreateWebinarResponseSettingsQuestionAndAnswer(RequiredWebinarsCreateWebinarResponseSettingsQuestionAndAnswer, OptionalWebinarsCreateWebinarResponseSettingsQuestionAndAnswer):
    pass
