...
class RequiredMeetingsGetDetailsResponseTrackingFieldsItem(TypedDict):
    pass

class OptionalMeetingsGetDetailsResponseTrackingFieldsItem(TypedDict, total=False):
...
class MeetingsGetDetailsResponseTrackingFieldsItem(RequiredMeetingsGetDetailsResponseTrackingFieldsItem, OptionalMeetingsGetDetailsResponseTrackingFieldsItem):
    pass
