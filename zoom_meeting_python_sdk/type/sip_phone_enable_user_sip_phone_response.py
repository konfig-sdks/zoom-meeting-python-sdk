...
class RequiredSipPhoneEnableUserSipPhoneResponse(TypedDict):
    pass

class OptionalSipPhoneEnableUserSipPhoneResponse(TypedDict, total=False):
    # The SIP phone ID.
    id: str
...
class SipPhoneEnableUserSipPhoneResponse(RequiredSipPhoneEnableUserSipPhoneResponse, OptionalSipPhoneEnableUserSipPhoneResponse):
    pass
