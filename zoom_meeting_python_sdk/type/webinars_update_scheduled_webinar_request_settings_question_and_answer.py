...
class RequiredWebinarsUpdateScheduledWebinarRequestSettingsQuestionAndAnswer(TypedDict):
    pass

class OptionalWebinarsUpdateScheduledWebinarRequestSettingsQuestionAndAnswer(TypedDict, total=False):
...
class WebinarsUpdateScheduledWebinarRequestSettingsQuestionAndAnswer(RequiredWebinarsUpdateScheduledWebinarRequestSettingsQuestionAndAnswer, OptionalWebinarsUpdateScheduledWebinarRequestSettingsQuestionAndAnswer):
    pass
