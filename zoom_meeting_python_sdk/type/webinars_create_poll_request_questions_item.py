...
from zoom_meeting_python_sdk.type.webinars_create_poll_request_questions_item_answers import WebinarsCreatePollRequestQuestionsItemAnswers
from zoom_meeting_python_sdk.type.webinars_create_poll_request_questions_item_prompts import WebinarsCreatePollRequestQuestionsItemPrompts
from zoom_meeting_python_sdk.type.webinars_create_poll_request_questions_item_right_answers import WebinarsCreatePollRequestQuestionsItemRightAnswers

class RequiredWebinarsCreatePollRequestQuestionsItem(TypedDict):
    pass

class OptionalWebinarsCreatePollRequestQuestionsItem(TypedDict, total=False):
    ...
    answers: WebinarsCreatePollRequestQuestionsItemAnswers
    ...
    prompts: WebinarsCreatePollRequestQuestionsItemPrompts
    ...
    right_answers: WebinarsCreatePollRequestQuestionsItemRightAnswers
...
class WebinarsCreatePollRequestQuestionsItem(RequiredWebinarsCreatePollRequestQuestionsItem, OptionalWebinarsCreatePollRequestQuestionsItem):
    pass
