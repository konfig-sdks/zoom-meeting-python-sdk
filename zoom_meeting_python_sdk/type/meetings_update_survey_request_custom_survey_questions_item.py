...
from zoom_meeting_python_sdk.type.meetings_update_survey_request_custom_survey_questions_item_answers import MeetingsUpdateSurveyRequestCustomSurveyQuestionsItemAnswers
from zoom_meeting_python_sdk.type.meetings_update_survey_request_custom_survey_questions_item_prompts import MeetingsUpdateSurveyRequestCustomSurveyQuestionsItemPrompts

class RequiredMeetingsUpdateSurveyRequestCustomSurveyQuestionsItem(TypedDict):
    pass

class OptionalMeetingsUpdateSurveyRequestCustomSurveyQuestionsItem(TypedDict, total=False):
    ...
    answers: MeetingsUpdateSurveyRequestCustomSurveyQuestionsItemAnswers

    prompts: MeetingsUpdateSurveyRequestCustomSurveyQuestionsItemPrompts
...
class MeetingsUpdateSurveyRequestCustomSurveyQuestionsItem(RequiredMeetingsUpdateSurveyRequestCustomSurveyQuestionsItem, OptionalMeetingsUpdateSurveyRequestCustomSurveyQuestionsItem):
    pass
