...
from zoom_meeting_python_sdk.type.webinars_update_scheduled_webinar_request_settings_attendees_and_panelists_reminder_email_notification import WebinarsUpdateScheduledWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification
from zoom_meeting_python_sdk.type.webinars_update_scheduled_webinar_request_settings_follow_up_absentees_email_notification import WebinarsUpdateScheduledWebinarRequestSettingsFollowUpAbsenteesEmailNotification
from zoom_meeting_python_sdk.type.webinars_update_scheduled_webinar_request_settings_follow_up_attendees_email_notification import WebinarsUpdateScheduledWebinarRequestSettingsFollowUpAttendeesEmailNotification
from zoom_meeting_python_sdk.type.webinars_update_scheduled_webinar_request_settings_global_dial_in_countries import WebinarsUpdateScheduledWebinarRequestSettingsGlobalDialInCountries
from zoom_meeting_python_sdk.type.webinars_update_scheduled_webinar_request_settings_language_interpretation import WebinarsUpdateScheduledWebinarRequestSettingsLanguageInterpretation
from zoom_meeting_python_sdk.type.webinars_update_scheduled_webinar_request_settings_question_and_answer import WebinarsUpdateScheduledWebinarRequestSettingsQuestionAndAnswer
from zoom_meeting_python_sdk.type.webinars_update_scheduled_webinar_request_settings_sign_language_interpretation import WebinarsUpdateScheduledWebinarRequestSettingsSignLanguageInterpretation

class RequiredWebinarsUpdateScheduledWebinarRequestSettings(TypedDict):
    pass

class OptionalWebinarsUpdateScheduledWebinarRequestSettings(TypedDict, total=False):
    ...
    global_dial_in_countries: WebinarsUpdateScheduledWebinarRequestSettingsGlobalDialInCountries
...
class WebinarsUpdateScheduledWebinarRequestSettings(RequiredWebinarsUpdateScheduledWebinarRequestSettings, OptionalWebinarsUpdateScheduledWebinarRequestSettings):
    pass
