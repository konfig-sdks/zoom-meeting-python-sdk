...
class RequiredMeetingsUpdateDetailsRequestRecurrence(TypedDict):
    # Recurrence meeting types.   `1` - Daily.    `2` - Weekly.    `3` - Monthly.
    type: int

class OptionalMeetingsUpdateDetailsRequestRecurrence(TypedDict, total=False):
...
class MeetingsUpdateDetailsRequestRecurrence(RequiredMeetingsUpdateDetailsRequestRecurrence, OptionalMeetingsUpdateDetailsRequestRecurrence):
    pass
