...
from zoom_meeting_python_sdk.type.meetings_get_registrant_details_response_custom_questions import MeetingsGetRegistrantDetailsResponseCustomQuestions

class RequiredMeetingsGetRegistrantDetailsResponse(TypedDict):
...
class OptionalMeetingsGetRegistrantDetailsResponse(TypedDict, total=False):
    id: str
    ...
    custom_questions: MeetingsGetRegistrantDetailsResponseCustomQuestions
...
class MeetingsGetRegistrantDetailsResponse(RequiredMeetingsGetRegistrantDetailsResponse, OptionalMeetingsGetRegistrantDetailsResponse):
    pass
