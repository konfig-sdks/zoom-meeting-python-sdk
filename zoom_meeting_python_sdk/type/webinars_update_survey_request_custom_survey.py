...
from zoom_meeting_python_sdk.type.webinars_update_survey_request_custom_survey_questions import WebinarsUpdateSurveyRequestCustomSurveyQuestions

class RequiredWebinarsUpdateSurveyRequestCustomSurvey(TypedDict):
    pass

class OptionalWebinarsUpdateSurveyRequestCustomSurvey(TypedDict, total=False):
    ...
    questions: WebinarsUpdateSurveyRequestCustomSurveyQuestions

class WebinarsUpdateSurveyRequestCustomSurvey(RequiredWebinarsUpdateSurveyRequestCustomSurvey, OptionalWebinarsUpdateSurveyRequestCustomSurvey):
    pass
