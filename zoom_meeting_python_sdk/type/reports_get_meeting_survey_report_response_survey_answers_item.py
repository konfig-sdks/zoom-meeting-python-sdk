...
from zoom_meeting_python_sdk.type.reports_get_meeting_survey_report_response_survey_answers_item_answer_details import ReportsGetMeetingSurveyReportResponseSurveyAnswersItemAnswerDetails

class RequiredReportsGetMeetingSurveyReportResponseSurveyAnswersItem(TypedDict):
    pass

class OptionalReportsGetMeetingSurveyReportResponseSurveyAnswersItem(TypedDict, total=False):
    ...
    answer_details: ReportsGetMeetingSurveyReportResponseSurveyAnswersItemAnswerDetails

class ReportsGetMeetingSurveyReportResponseSurveyAnswersItem(RequiredReportsGetMeetingSurveyReportResponseSurveyAnswersItem, OptionalReportsGetMeetingSurveyReportResponseSurveyAnswersItem):
    pass
