...
from zoom_meeting_python_sdk.type.webinars_get_survey_response_custom_survey_questions_item_answers import WebinarsGetSurveyResponseCustomSurveyQuestionsItemAnswers
from zoom_meeting_python_sdk.type.webinars_get_survey_response_custom_survey_questions_item_prompts import WebinarsGetSurveyResponseCustomSurveyQuestionsItemPrompts

class RequiredWebinarsGetSurveyResponseCustomSurveyQuestionsItem(TypedDict):
    pass

class OptionalWebinarsGetSurveyResponseCustomSurveyQuestionsItem(TypedDict, total=False):
    ...
    answers: WebinarsGetSurveyResponseCustomSurveyQuestionsItemAnswers

    prompts: WebinarsGetSurveyResponseCustomSurveyQuestionsItemPrompts
...
class WebinarsGetSurveyResponseCustomSurveyQuestionsItem(RequiredWebinarsGetSurveyResponseCustomSurveyQuestionsItem, OptionalWebinarsGetSurveyResponseCustomSurveyQuestionsItem):
    pass
