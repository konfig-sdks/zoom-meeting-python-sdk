...
from zoom_meeting_python_sdk.type.meetings_create_poll_response_questions_item_answers import MeetingsCreatePollResponseQuestionsItemAnswers
from zoom_meeting_python_sdk.type.meetings_create_poll_response_questions_item_prompts import MeetingsCreatePollResponseQuestionsItemPrompts
from zoom_meeting_python_sdk.type.meetings_create_poll_response_questions_item_right_answers import MeetingsCreatePollResponseQuestionsItemRightAnswers

class RequiredMeetingsCreatePollResponseQuestionsItem(TypedDict):
    pass

class OptionalMeetingsCreatePollResponseQuestionsItem(TypedDict, total=False):
    ...
    answers: MeetingsCreatePollResponseQuestionsItemAnswers
    ...
    prompts: MeetingsCreatePollResponseQuestionsItemPrompts
    ...
    right_answers: MeetingsCreatePollResponseQuestionsItemRightAnswers
...
class MeetingsCreatePollResponseQuestionsItem(RequiredMeetingsCreatePollResponseQuestionsItem, OptionalMeetingsCreatePollResponseQuestionsItem):
    pass
