...
from zoom_meeting_python_sdk.type.meetings_get_poll_response_questions_item_answers import MeetingsGetPollResponseQuestionsItemAnswers
from zoom_meeting_python_sdk.type.meetings_get_poll_response_questions_item_prompts import MeetingsGetPollResponseQuestionsItemPrompts
from zoom_meeting_python_sdk.type.meetings_get_poll_response_questions_item_right_answers import MeetingsGetPollResponseQuestionsItemRightAnswers

class RequiredMeetingsGetPollResponseQuestionsItem(TypedDict):
    pass

class OptionalMeetingsGetPollResponseQuestionsItem(TypedDict, total=False):
    ...
    answers: MeetingsGetPollResponseQuestionsItemAnswers
    ...
    prompts: MeetingsGetPollResponseQuestionsItemPrompts
    ...
    right_answers: MeetingsGetPollResponseQuestionsItemRightAnswers
...
class MeetingsGetPollResponseQuestionsItem(RequiredMeetingsGetPollResponseQuestionsItem, OptionalMeetingsGetPollResponseQuestionsItem):
    pass
