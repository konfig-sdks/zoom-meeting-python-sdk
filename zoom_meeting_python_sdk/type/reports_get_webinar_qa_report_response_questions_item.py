...
from zoom_meeting_python_sdk.type.reports_get_webinar_qa_report_response_questions_item_question_details import ReportsGetWebinarQaReportResponseQuestionsItemQuestionDetails

class RequiredReportsGetWebinarQaReportResponseQuestionsItem(TypedDict):
    pass

class OptionalReportsGetWebinarQaReportResponseQuestionsItem(TypedDict, total=False):
    ...
    question_details: ReportsGetWebinarQaReportResponseQuestionsItemQuestionDetails

class ReportsGetWebinarQaReportResponseQuestionsItem(RequiredReportsGetWebinarQaReportResponseQuestionsItem, OptionalReportsGetWebinarQaReportResponseQuestionsItem):
    pass
