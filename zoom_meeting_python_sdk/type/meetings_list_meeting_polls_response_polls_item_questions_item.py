...
from zoom_meeting_python_sdk.type.meetings_list_meeting_polls_response_polls_item_questions_item_answers import MeetingsListMeetingPollsResponsePollsItemQuestionsItemAnswers
from zoom_meeting_python_sdk.type.meetings_list_meeting_polls_response_polls_item_questions_item_prompts import MeetingsListMeetingPollsResponsePollsItemQuestionsItemPrompts
from zoom_meeting_python_sdk.type.meetings_list_meeting_polls_response_polls_item_questions_item_right_answers import MeetingsListMeetingPollsResponsePollsItemQuestionsItemRightAnswers

class RequiredMeetingsListMeetingPollsResponsePollsItemQuestionsItem(TypedDict):
    pass

class OptionalMeetingsListMeetingPollsResponsePollsItemQuestionsItem(TypedDict, total=False):
    ...
    answers: MeetingsListMeetingPollsResponsePollsItemQuestionsItemAnswers
    ...
    prompts: MeetingsListMeetingPollsResponsePollsItemQuestionsItemPrompts
    ...
    right_answers: MeetingsListMeetingPollsResponsePollsItemQuestionsItemRightAnswers
...
class MeetingsListMeetingPollsResponsePollsItemQuestionsItem(RequiredMeetingsListMeetingPollsResponsePollsItemQuestionsItem, OptionalMeetingsListMeetingPollsResponsePollsItemQuestionsItem):
    pass
