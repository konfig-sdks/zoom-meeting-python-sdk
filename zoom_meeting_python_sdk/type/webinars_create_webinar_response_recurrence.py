...
class RequiredWebinarsCreateWebinarResponseRecurrence(TypedDict):
    # Recurrence webinar types.   `1` - Daily.    `2` - Weekly.    `3` - Monthly.
    type: int

class OptionalWebinarsCreateWebinarResponseRecurrence(TypedDict, total=False):
...
class WebinarsCreateWebinarResponseRecurrence(RequiredWebinarsCreateWebinarResponseRecurrence, OptionalWebinarsCreateWebinarResponseRecurrence):
    pass
