...
class RequiredMeetingsCreateMeetingRequestRecurrence(TypedDict):
    # Recurrence meeting types.  `1` - Daily.    `2` - Weekly.    `3` - Monthly.
    type: int

class OptionalMeetingsCreateMeetingRequestRecurrence(TypedDict, total=False):
...
class MeetingsCreateMeetingRequestRecurrence(RequiredMeetingsCreateMeetingRequestRecurrence, OptionalMeetingsCreateMeetingRequestRecurrence):
    pass
