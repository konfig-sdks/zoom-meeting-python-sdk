...
class RequiredSipPhoneEnableUserSipPhoneRequest(TypedDict):
...
class OptionalSipPhoneEnableUserSipPhoneRequest(TypedDict, total=False):
...
class SipPhoneEnableUserSipPhoneRequest(RequiredSipPhoneEnableUserSipPhoneRequest, OptionalSipPhoneEnableUserSipPhoneRequest):
    pass
