...
from zoom_meeting_python_sdk.type.webinars_list_polls_response_polls_item_questions_item_answers import WebinarsListPollsResponsePollsItemQuestionsItemAnswers
from zoom_meeting_python_sdk.type.webinars_list_polls_response_polls_item_questions_item_prompts import WebinarsListPollsResponsePollsItemQuestionsItemPrompts
from zoom_meeting_python_sdk.type.webinars_list_polls_response_polls_item_questions_item_right_answers import WebinarsListPollsResponsePollsItemQuestionsItemRightAnswers

class RequiredWebinarsListPollsResponsePollsItemQuestionsItem(TypedDict):
    pass

class OptionalWebinarsListPollsResponsePollsItemQuestionsItem(TypedDict, total=False):
    ...
    answers: WebinarsListPollsResponsePollsItemQuestionsItemAnswers
    ...
    prompts: WebinarsListPollsResponsePollsItemQuestionsItemPrompts
    ...
    right_answers: WebinarsListPollsResponsePollsItemQuestionsItemRightAnswers
...
class WebinarsListPollsResponsePollsItemQuestionsItem(RequiredWebinarsListPollsResponsePollsItemQuestionsItem, OptionalWebinarsListPollsResponsePollsItemQuestionsItem):
    pass
