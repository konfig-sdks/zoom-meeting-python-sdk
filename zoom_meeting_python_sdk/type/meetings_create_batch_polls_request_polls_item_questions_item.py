...
from zoom_meeting_python_sdk.type.meetings_create_batch_polls_request_polls_item_questions_item_answers import MeetingsCreateBatchPollsRequestPollsItemQuestionsItemAnswers
from zoom_meeting_python_sdk.type.meetings_create_batch_polls_request_polls_item_questions_item_prompts import MeetingsCreateBatchPollsRequestPollsItemQuestionsItemPrompts
from zoom_meeting_python_sdk.type.meetings_create_batch_polls_request_polls_item_questions_item_right_answers import MeetingsCreateBatchPollsRequestPollsItemQuestionsItemRightAnswers

class RequiredMeetingsCreateBatchPollsRequestPollsItemQuestionsItem(TypedDict):
    pass

class OptionalMeetingsCreateBatchPollsRequestPollsItemQuestionsItem(TypedDict, total=False):
    ...
    answers: MeetingsCreateBatchPollsRequestPollsItemQuestionsItemAnswers
    ...
    prompts: MeetingsCreateBatchPollsRequestPollsItemQuestionsItemPrompts
    ...
    right_answers: MeetingsCreateBatchPollsRequestPollsItemQuestionsItemRightAnswers
...
class MeetingsCreateBatchPollsRequestPollsItemQuestionsItem(RequiredMeetingsCreateBatchPollsRequestPollsItemQuestionsItem, OptionalMeetingsCreateBatchPollsRequestPollsItemQuestionsItem):
    pass
