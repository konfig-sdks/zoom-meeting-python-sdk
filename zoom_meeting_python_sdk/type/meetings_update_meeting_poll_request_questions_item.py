...
from zoom_meeting_python_sdk.type.meetings_update_meeting_poll_request_questions_item_answers import MeetingsUpdateMeetingPollRequestQuestionsItemAnswers
from zoom_meeting_python_sdk.type.meetings_update_meeting_poll_request_questions_item_prompts import MeetingsUpdateMeetingPollRequestQuestionsItemPrompts
from zoom_meeting_python_sdk.type.meetings_update_meeting_poll_request_questions_item_right_answers import MeetingsUpdateMeetingPollRequestQuestionsItemRightAnswers

class RequiredMeetingsUpdateMeetingPollRequestQuestionsItem(TypedDict):
    pass

class OptionalMeetingsUpdateMeetingPollRequestQuestionsItem(TypedDict, total=False):
    ...
    answers: MeetingsUpdateMeetingPollRequestQuestionsItemAnswers
    ...
    prompts: MeetingsUpdateMeetingPollRequestQuestionsItemPrompts
    ...
    right_answers: MeetingsUpdateMeetingPollRequestQuestionsItemRightAnswers
...
class MeetingsUpdateMeetingPollRequestQuestionsItem(RequiredMeetingsUpdateMeetingPollRequestQuestionsItem, OptionalMeetingsUpdateMeetingPollRequestQuestionsItem):
    pass
