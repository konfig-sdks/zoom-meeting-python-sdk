...
class RequiredWebinarsGetDetailsResponseOccurrencesItem(TypedDict):
    pass

class OptionalWebinarsGetDetailsResponseOccurrencesItem(TypedDict, total=False):
    # Duration.
    duration: int
...
class WebinarsGetDetailsResponseOccurrencesItem(RequiredWebinarsGetDetailsResponseOccurrencesItem, OptionalWebinarsGetDetailsResponseOccurrencesItem):
    pass
