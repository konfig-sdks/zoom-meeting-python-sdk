...
class RequiredCloudRecordingGetSettingsResponse(TypedDict):
    pass

class OptionalCloudRecordingGetSettingsResponse(TypedDict, total=False):
...
class CloudRecordingGetSettingsResponse(RequiredCloudRecordingGetSettingsResponse, OptionalCloudRecordingGetSettingsResponse):
    pass
