...
from zoom_meeting_python_sdk.type.webinars_get_poll_details_response_questions import WebinarsGetPollDetailsResponseQuestions

class RequiredWebinarsGetPollDetailsResponse(TypedDict):
    pass

class OptionalWebinarsGetPollDetailsResponse(TypedDict, total=False):
    ...
    questions: WebinarsGetPollDetailsResponseQuestions

class WebinarsGetPollDetailsResponse(RequiredWebinarsGetPollDetailsResponse, OptionalWebinarsGetPollDetailsResponse):
    pass
