...
class RequiredCloudRecordingCreateRegistrantRequest(TypedDict):
...
class OptionalCloudRecordingCreateRegistrantRequest(TypedDict, total=False):
...
class CloudRecordingCreateRegistrantRequest(RequiredCloudRecordingCreateRegistrantRequest, OptionalCloudRecordingCreateRegistrantRequest):
    pass
