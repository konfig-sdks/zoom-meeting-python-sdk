...
class RequiredMeetingsGetDetailsResponseRecurrence(TypedDict):
    # Recurrence meeting types:    `1` - Daily.    `2` - Weekly.    `3` - Monthly.
    type: int

class OptionalMeetingsGetDetailsResponseRecurrence(TypedDict, total=False):
...
class MeetingsGetDetailsResponseRecurrence(RequiredMeetingsGetDetailsResponseRecurrence, OptionalMeetingsGetDetailsResponseRecurrence):
    pass
