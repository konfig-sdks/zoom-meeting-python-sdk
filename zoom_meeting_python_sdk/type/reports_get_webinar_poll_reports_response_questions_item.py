...
from zoom_meeting_python_sdk.type.reports_get_webinar_poll_reports_response_questions_item_question_details import ReportsGetWebinarPollReportsResponseQuestionsItemQuestionDetails

class RequiredReportsGetWebinarPollReportsResponseQuestionsItem(TypedDict):
    pass

class OptionalReportsGetWebinarPollReportsResponseQuestionsItem(TypedDict, total=False):
    ...
    question_details: ReportsGetWebinarPollReportsResponseQuestionsItemQuestionDetails

class ReportsGetWebinarPollReportsResponseQuestionsItem(RequiredReportsGetWebinarPollReportsResponseQuestionsItem, OptionalReportsGetWebinarPollReportsResponseQuestionsItem):
    pass
