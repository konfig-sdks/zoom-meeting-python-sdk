...
from zoom_meeting_python_sdk.type.meetings_update_details_request_settings_approved_or_denied_countries_or_regions import MeetingsUpdateDetailsRequestSettingsApprovedOrDeniedCountriesOrRegions
from zoom_meeting_python_sdk.type.meetings_update_details_request_settings_authentication_exception import MeetingsUpdateDetailsRequestSettingsAuthenticationException
from zoom_meeting_python_sdk.type.meetings_update_details_request_settings_breakout_room import MeetingsUpdateDetailsRequestSettingsBreakoutRoom
from zoom_meeting_python_sdk.type.meetings_update_details_request_settings_continuous_meeting_chat import MeetingsUpdateDetailsRequestSettingsContinuousMeetingChat
from zoom_meeting_python_sdk.type.meetings_update_details_request_settings_custom_keys import MeetingsUpdateDetailsRequestSettingsCustomKeys
from zoom_meeting_python_sdk.type.meetings_update_details_request_settings_global_dial_in_countries import MeetingsUpdateDetailsRequestSettingsGlobalDialInCountries
from zoom_meeting_python_sdk.type.meetings_update_details_request_settings_global_dial_in_numbers import MeetingsUpdateDetailsRequestSettingsGlobalDialInNumbers
from zoom_meeting_python_sdk.type.meetings_update_details_request_settings_language_interpretation import MeetingsUpdateDetailsRequestSettingsLanguageInterpretation
from zoom_meeting_python_sdk.type.meetings_update_details_request_settings_meeting_invitees import MeetingsUpdateDetailsRequestSettingsMeetingInvitees
from zoom_meeting_python_sdk.type.meetings_update_details_request_settings_resources import MeetingsUpdateDetailsRequestSettingsResources
from zoom_meeting_python_sdk.type.meetings_update_details_request_settings_sign_language_interpretation import MeetingsUpdateDetailsRequestSettingsSignLanguageInterpretation

class RequiredMeetingsUpdateDetailsRequestSettings(TypedDict):
    pass

class OptionalMeetingsUpdateDetailsRequestSettings(TypedDict, total=False):
    ...
    authentication_exception: MeetingsUpdateDetailsRequestSettingsAuthenticationException
    ...
    custom_keys: MeetingsUpdateDetailsRequestSettingsCustomKeys
    ...
    global_dial_in_countries: MeetingsUpdateDetailsRequestSettingsGlobalDialInCountries

    global_dial_in_numbers: MeetingsUpdateDetailsRequestSettingsGlobalDialInNumbers
    ...
    meeting_invitees: MeetingsUpdateDetailsRequestSettingsMeetingInvitees
    ...
    resources: MeetingsUpdateDetailsRequestSettingsResources
...
class MeetingsUpdateDetailsRequestSettings(RequiredMeetingsUpdateDetailsRequestSettings, OptionalMeetingsUpdateDetailsRequestSettings):
    pass
