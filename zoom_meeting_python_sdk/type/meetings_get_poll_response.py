...
from zoom_meeting_python_sdk.type.meetings_get_poll_response_questions import MeetingsGetPollResponseQuestions

class RequiredMeetingsGetPollResponse(TypedDict):
    pass

class OptionalMeetingsGetPollResponse(TypedDict, total=False):
    ...
    questions: MeetingsGetPollResponseQuestions

class MeetingsGetPollResponse(RequiredMeetingsGetPollResponse, OptionalMeetingsGetPollResponse):
    pass
