...
from zoom_meeting_python_sdk.pydantic.reports_get_meeting_qa_report_response_questions_item_question_details_item_answer_details import ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItemAnswerDetails

class ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItem(BaseModel):
    ...
    answer_details: typing.Optional[ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetailsItemAnswerDetails] = Field(None, alias='answer_details')
