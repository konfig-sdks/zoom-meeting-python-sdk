...
from zoom_meeting_python_sdk.pydantic.webinars_get_poll_details_response_questions_item_answers import WebinarsGetPollDetailsResponseQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.webinars_get_poll_details_response_questions_item_prompts import WebinarsGetPollDetailsResponseQuestionsItemPrompts
from zoom_meeting_python_sdk.pydantic.webinars_get_poll_details_response_questions_item_right_answers import WebinarsGetPollDetailsResponseQuestionsItemRightAnswers

class WebinarsGetPollDetailsResponseQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[WebinarsGetPollDetailsResponseQuestionsItemAnswers] = Field(None, alias='answers')
    ...
    prompts: typing.Optional[WebinarsGetPollDetailsResponseQuestionsItemPrompts] = Field(None, alias='prompts')
    ...
    right_answers: typing.Optional[WebinarsGetPollDetailsResponseQuestionsItemRightAnswers] = Field(None, alias='right_answers')
