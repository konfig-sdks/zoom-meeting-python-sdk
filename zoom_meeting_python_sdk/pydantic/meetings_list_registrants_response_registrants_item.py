...
from zoom_meeting_python_sdk.pydantic.meetings_list_registrants_response_registrants_item_custom_questions import MeetingsListRegistrantsResponseRegistrantsItemCustomQuestions

class MeetingsListRegistrantsResponseRegistrantsItem(BaseModel):
    ...
    custom_questions: typing.Optional[MeetingsListRegistrantsResponseRegistrantsItemCustomQuestions] = Field(None, alias='custom_questions')
