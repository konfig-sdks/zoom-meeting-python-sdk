...
from zoom_meeting_python_sdk.pydantic.meetings_update_survey_request_custom_survey_questions_item_answers import MeetingsUpdateSurveyRequestCustomSurveyQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.meetings_update_survey_request_custom_survey_questions_item_prompts import MeetingsUpdateSurveyRequestCustomSurveyQuestionsItemPrompts

class MeetingsUpdateSurveyRequestCustomSurveyQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[MeetingsUpdateSurveyRequestCustomSurveyQuestionsItemAnswers] = Field(None, alias='answers')

    prompts: typing.Optional[MeetingsUpdateSurveyRequestCustomSurveyQuestionsItemPrompts] = Field(None, alias='prompts')
