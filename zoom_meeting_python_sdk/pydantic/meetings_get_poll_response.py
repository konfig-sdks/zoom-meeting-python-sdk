...
from zoom_meeting_python_sdk.pydantic.meetings_get_poll_response_questions import MeetingsGetPollResponseQuestions

class MeetingsGetPollResponse(BaseModel):
    ...
    questions: typing.Optional[MeetingsGetPollResponseQuestions] = Field(None, alias='questions')
