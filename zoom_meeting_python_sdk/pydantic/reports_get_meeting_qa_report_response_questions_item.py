...
from zoom_meeting_python_sdk.pydantic.reports_get_meeting_qa_report_response_questions_item_question_details import ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetails

class ReportsGetMeetingQaReportResponseQuestionsItem(BaseModel):
    ...
    question_details: typing.Optional[ReportsGetMeetingQaReportResponseQuestionsItemQuestionDetails] = Field(None, alias='question_details')
