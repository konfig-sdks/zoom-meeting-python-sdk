...
from zoom_meeting_python_sdk.pydantic.meetings_create_batch_polls_request_polls_item_questions_item_answers import MeetingsCreateBatchPollsRequestPollsItemQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.meetings_create_batch_polls_request_polls_item_questions_item_prompts import MeetingsCreateBatchPollsRequestPollsItemQuestionsItemPrompts
from zoom_meeting_python_sdk.pydantic.meetings_create_batch_polls_request_polls_item_questions_item_right_answers import MeetingsCreateBatchPollsRequestPollsItemQuestionsItemRightAnswers

class MeetingsCreateBatchPollsRequestPollsItemQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[MeetingsCreateBatchPollsRequestPollsItemQuestionsItemAnswers] = Field(None, alias='answers')
    ...
    prompts: typing.Optional[MeetingsCreateBatchPollsRequestPollsItemQuestionsItemPrompts] = Field(None, alias='prompts')
    ...
    right_answers: typing.Optional[MeetingsCreateBatchPollsRequestPollsItemQuestionsItemRightAnswers] = Field(None, alias='right_answers')
