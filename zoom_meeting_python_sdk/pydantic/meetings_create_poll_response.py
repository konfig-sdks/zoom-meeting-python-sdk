...
from zoom_meeting_python_sdk.pydantic.meetings_create_poll_response_questions import MeetingsCreatePollResponseQuestions

class MeetingsCreatePollResponse(BaseModel):
    ...
    questions: typing.Optional[MeetingsCreatePollResponseQuestions] = Field(None, alias='questions')
