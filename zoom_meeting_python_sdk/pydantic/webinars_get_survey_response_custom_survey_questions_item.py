...
from zoom_meeting_python_sdk.pydantic.webinars_get_survey_response_custom_survey_questions_item_answers import WebinarsGetSurveyResponseCustomSurveyQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.webinars_get_survey_response_custom_survey_questions_item_prompts import WebinarsGetSurveyResponseCustomSurveyQuestionsItemPrompts

class WebinarsGetSurveyResponseCustomSurveyQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[WebinarsGetSurveyResponseCustomSurveyQuestionsItemAnswers] = Field(None, alias='answers')

    prompts: typing.Optional[WebinarsGetSurveyResponseCustomSurveyQuestionsItemPrompts] = Field(None, alias='prompts')
