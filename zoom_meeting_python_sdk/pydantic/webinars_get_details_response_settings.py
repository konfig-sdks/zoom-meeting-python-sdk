...
from zoom_meeting_python_sdk.pydantic.webinars_get_details_response_settings_attendees_and_panelists_reminder_email_notification import WebinarsGetDetailsResponseSettingsAttendeesAndPanelistsReminderEmailNotification
from zoom_meeting_python_sdk.pydantic.webinars_get_details_response_settings_follow_up_absentees_email_notification import WebinarsGetDetailsResponseSettingsFollowUpAbsenteesEmailNotification
from zoom_meeting_python_sdk.pydantic.webinars_get_details_response_settings_follow_up_attendees_email_notification import WebinarsGetDetailsResponseSettingsFollowUpAttendeesEmailNotification
from zoom_meeting_python_sdk.pydantic.webinars_get_details_response_settings_global_dial_in_countries import WebinarsGetDetailsResponseSettingsGlobalDialInCountries
from zoom_meeting_python_sdk.pydantic.webinars_get_details_response_settings_language_interpretation import WebinarsGetDetailsResponseSettingsLanguageInterpretation
from zoom_meeting_python_sdk.pydantic.webinars_get_details_response_settings_question_and_answer import WebinarsGetDetailsResponseSettingsQuestionAndAnswer
from zoom_meeting_python_sdk.pydantic.webinars_get_details_response_settings_sign_language_interpretation import WebinarsGetDetailsResponseSettingsSignLanguageInterpretation

class WebinarsGetDetailsResponseSettings(BaseModel):
    ...
    attendees_and_panelists_reminder_email_notification: typing.Optional[WebinarsGetDetailsResponseSettingsAttendeesAndPanelistsReminderEmailNotification] = Field(None, alias='attendees_and_panelists_reminder_email_notification')
    ...
    follow_up_absentees_email_notification: typing.Optional[WebinarsGetDetailsResponseSettingsFollowUpAbsenteesEmailNotification] = Field(None, alias='follow_up_absentees_email_notification')

    follow_up_attendees_email_notification: typing.Optional[WebinarsGetDetailsResponseSettingsFollowUpAttendeesEmailNotification] = Field(None, alias='follow_up_attendees_email_notification')

    global_dial_in_countries: typing.Optional[WebinarsGetDetailsResponseSettingsGlobalDialInCountries] = Field(None, alias='global_dial_in_countries')
    ...
    language_interpretation: typing.Optional[WebinarsGetDetailsResponseSettingsLanguageInterpretation] = Field(None, alias='language_interpretation')

    sign_language_interpretation: typing.Optional[WebinarsGetDetailsResponseSettingsSignLanguageInterpretation] = Field(None, alias='sign_language_interpretation')
    ...
    question_and_answer: typing.Optional[WebinarsGetDetailsResponseSettingsQuestionAndAnswer] = Field(None, alias='question_and_answer')
