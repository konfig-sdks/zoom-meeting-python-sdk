...
from zoom_meeting_python_sdk.pydantic.webinars_create_poll_response_questions import WebinarsCreatePollResponseQuestions

class WebinarsCreatePollResponse(BaseModel):
    ...
    questions: typing.Optional[WebinarsCreatePollResponseQuestions] = Field(None, alias='questions')
