...
from zoom_meeting_python_sdk.pydantic.meetings_create_poll_request_questions_item_answers import MeetingsCreatePollRequestQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.meetings_create_poll_request_questions_item_prompts import MeetingsCreatePollRequestQuestionsItemPrompts
from zoom_meeting_python_sdk.pydantic.meetings_create_poll_request_questions_item_right_answers import MeetingsCreatePollRequestQuestionsItemRightAnswers

class MeetingsCreatePollRequestQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[MeetingsCreatePollRequestQuestionsItemAnswers] = Field(None, alias='answers')
    ...
    prompts: typing.Optional[MeetingsCreatePollRequestQuestionsItemPrompts] = Field(None, alias='prompts')
    ...
    right_answers: typing.Optional[MeetingsCreatePollRequestQuestionsItemRightAnswers] = Field(None, alias='right_answers')
