...
from zoom_meeting_python_sdk.pydantic.meetings_list_registrants_response_registrants import MeetingsListRegistrantsResponseRegistrants

class MeetingsListRegistrantsResponse(BaseModel):
    ...
    registrants: typing.Optional[MeetingsListRegistrantsResponseRegistrants] = Field(None, alias='registrants')
