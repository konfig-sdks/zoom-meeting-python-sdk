...
from zoom_meeting_python_sdk.pydantic.webinars_create_poll_request_questions import WebinarsCreatePollRequestQuestions

class WebinarsCreatePollRequest(BaseModel):
    ...
    questions: typing.Optional[WebinarsCreatePollRequestQuestions] = Field(None, alias='questions')
