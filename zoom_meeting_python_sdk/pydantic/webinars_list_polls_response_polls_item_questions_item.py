...
from zoom_meeting_python_sdk.pydantic.webinars_list_polls_response_polls_item_questions_item_answers import WebinarsListPollsResponsePollsItemQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.webinars_list_polls_response_polls_item_questions_item_prompts import WebinarsListPollsResponsePollsItemQuestionsItemPrompts
from zoom_meeting_python_sdk.pydantic.webinars_list_polls_response_polls_item_questions_item_right_answers import WebinarsListPollsResponsePollsItemQuestionsItemRightAnswers

class WebinarsListPollsResponsePollsItemQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[WebinarsListPollsResponsePollsItemQuestionsItemAnswers] = Field(None, alias='answers')
    ...
    prompts: typing.Optional[WebinarsListPollsResponsePollsItemQuestionsItemPrompts] = Field(None, alias='prompts')
    ...
    right_answers: typing.Optional[WebinarsListPollsResponsePollsItemQuestionsItemRightAnswers] = Field(None, alias='right_answers')
