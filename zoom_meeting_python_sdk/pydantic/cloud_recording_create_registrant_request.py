...
from zoom_meeting_python_sdk.pydantic.cloud_recording_create_registrant_request_custom_questions import CloudRecordingCreateRegistrantRequestCustomQuestions

class CloudRecordingCreateRegistrantRequest(BaseModel):
    ...
    custom_questions: typing.Optional[CloudRecordingCreateRegistrantRequestCustomQuestions] = Field(None, alias='custom_questions')
