...
from zoom_meeting_python_sdk.pydantic.meetings_get_meeting_survey_response_custom_survey_questions import MeetingsGetMeetingSurveyResponseCustomSurveyQuestions

class MeetingsGetMeetingSurveyResponseCustomSurvey(BaseModel):
    ...
    questions: typing.Optional[MeetingsGetMeetingSurveyResponseCustomSurveyQuestions] = Field(None, alias='questions')
