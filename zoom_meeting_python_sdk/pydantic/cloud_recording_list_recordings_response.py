...
from zoom_meeting_python_sdk.pydantic.cloud_recording_list_recordings_response_meetings import CloudRecordingListRecordingsResponseMeetings

class CloudRecordingListRecordingsResponse(BaseModel):
    # The start date.
    ...
    meetings: typing.Optional[CloudRecordingListRecordingsResponseMeetings] = Field(None, alias='meetings')
