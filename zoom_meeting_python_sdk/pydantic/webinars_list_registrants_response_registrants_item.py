...
from zoom_meeting_python_sdk.pydantic.webinars_list_registrants_response_registrants_item_custom_questions import WebinarsListRegistrantsResponseRegistrantsItemCustomQuestions

class WebinarsListRegistrantsResponseRegistrantsItem(BaseModel):
    ...
    custom_questions: typing.Optional[WebinarsListRegistrantsResponseRegistrantsItemCustomQuestions] = Field(None, alias='custom_questions')
