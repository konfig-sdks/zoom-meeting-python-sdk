...
from zoom_meeting_python_sdk.pydantic.meetings_list_meeting_polls_response_polls_item_questions_item_answers import MeetingsListMeetingPollsResponsePollsItemQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.meetings_list_meeting_polls_response_polls_item_questions_item_prompts import MeetingsListMeetingPollsResponsePollsItemQuestionsItemPrompts
from zoom_meeting_python_sdk.pydantic.meetings_list_meeting_polls_response_polls_item_questions_item_right_answers import MeetingsListMeetingPollsResponsePollsItemQuestionsItemRightAnswers

class MeetingsListMeetingPollsResponsePollsItemQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[MeetingsListMeetingPollsResponsePollsItemQuestionsItemAnswers] = Field(None, alias='answers')
    ...
    prompts: typing.Optional[MeetingsListMeetingPollsResponsePollsItemQuestionsItemPrompts] = Field(None, alias='prompts')
    ...
    right_answers: typing.Optional[MeetingsListMeetingPollsResponsePollsItemQuestionsItemRightAnswers] = Field(None, alias='right_answers')
