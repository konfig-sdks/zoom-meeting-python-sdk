...
from zoom_meeting_python_sdk.pydantic.webinars_list_absentees_response_registrants import WebinarsListAbsenteesResponseRegistrants

class WebinarsListAbsenteesResponse(BaseModel):
    ...
    registrants: typing.Optional[WebinarsListAbsenteesResponseRegistrants] = Field(None, alias='registrants')
