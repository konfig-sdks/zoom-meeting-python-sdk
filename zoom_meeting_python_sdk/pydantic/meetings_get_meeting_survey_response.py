...
from zoom_meeting_python_sdk.pydantic.meetings_get_meeting_survey_response_custom_survey import MeetingsGetMeetingSurveyResponseCustomSurvey

class MeetingsGetMeetingSurveyResponse(BaseModel):
    custom_survey: typing.Optional[MeetingsGetMeetingSurveyResponseCustomSurvey] = Field(None, alias='custom_survey')
