...
from zoom_meeting_python_sdk.pydantic.webinars_create_webinar_response_settings_attendees_and_panelists_reminder_email_notification import WebinarsCreateWebinarResponseSettingsAttendeesAndPanelistsReminderEmailNotification
from zoom_meeting_python_sdk.pydantic.webinars_create_webinar_response_settings_follow_up_absentees_email_notification import WebinarsCreateWebinarResponseSettingsFollowUpAbsenteesEmailNotification
from zoom_meeting_python_sdk.pydantic.webinars_create_webinar_response_settings_follow_up_attendees_email_notification import WebinarsCreateWebinarResponseSettingsFollowUpAttendeesEmailNotification
from zoom_meeting_python_sdk.pydantic.webinars_create_webinar_response_settings_global_dial_in_countries import WebinarsCreateWebinarResponseSettingsGlobalDialInCountries
from zoom_meeting_python_sdk.pydantic.webinars_create_webinar_response_settings_language_interpretation import WebinarsCreateWebinarResponseSettingsLanguageInterpretation
from zoom_meeting_python_sdk.pydantic.webinars_create_webinar_response_settings_question_and_answer import WebinarsCreateWebinarResponseSettingsQuestionAndAnswer
from zoom_meeting_python_sdk.pydantic.webinars_create_webinar_response_settings_sign_language_interpretation import WebinarsCreateWebinarResponseSettingsSignLanguageInterpretation

class WebinarsCreateWebinarResponseSettings(BaseModel):
    ...
    attendees_and_panelists_reminder_email_notification: typing.Optional[WebinarsCreateWebinarResponseSettingsAttendeesAndPanelistsReminderEmailNotification] = Field(None, alias='attendees_and_panelists_reminder_email_notification')
    ...
    follow_up_absentees_email_notification: typing.Optional[WebinarsCreateWebinarResponseSettingsFollowUpAbsenteesEmailNotification] = Field(None, alias='follow_up_absentees_email_notification')

    follow_up_attendees_email_notification: typing.Optional[WebinarsCreateWebinarResponseSettingsFollowUpAttendeesEmailNotification] = Field(None, alias='follow_up_attendees_email_notification')

    global_dial_in_countries: typing.Optional[WebinarsCreateWebinarResponseSettingsGlobalDialInCountries] = Field(None, alias='global_dial_in_countries')
    ...
    language_interpretation: typing.Optional[WebinarsCreateWebinarResponseSettingsLanguageInterpretation] = Field(None, alias='language_interpretation')

    sign_language_interpretation: typing.Optional[WebinarsCreateWebinarResponseSettingsSignLanguageInterpretation] = Field(None, alias='sign_language_interpretation')
    ...
    question_and_answer: typing.Optional[WebinarsCreateWebinarResponseSettingsQuestionAndAnswer] = Field(None, alias='question_and_answer')
