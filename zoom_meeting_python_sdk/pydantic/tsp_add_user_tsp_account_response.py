...
from zoom_meeting_python_sdk.pydantic.tsp_add_user_tsp_account_response_dial_in_numbers import TspAddUserTspAccountResponseDialInNumbers

class TspAddUserTspAccountResponse(BaseModel):
    ...
    dial_in_numbers: typing.Optional[TspAddUserTspAccountResponseDialInNumbers] = Field(None, alias='dial_in_numbers')
