...
from zoom_meeting_python_sdk.pydantic.meetings_update_details_request_settings_approved_or_denied_countries_or_regions import MeetingsUpdateDetailsRequestSettingsApprovedOrDeniedCountriesOrRegions
from zoom_meeting_python_sdk.pydantic.meetings_update_details_request_settings_authentication_exception import MeetingsUpdateDetailsRequestSettingsAuthenticationException
from zoom_meeting_python_sdk.pydantic.meetings_update_details_request_settings_breakout_room import MeetingsUpdateDetailsRequestSettingsBreakoutRoom
from zoom_meeting_python_sdk.pydantic.meetings_update_details_request_settings_continuous_meeting_chat import MeetingsUpdateDetailsRequestSettingsContinuousMeetingChat
from zoom_meeting_python_sdk.pydantic.meetings_update_details_request_settings_custom_keys import MeetingsUpdateDetailsRequestSettingsCustomKeys
from zoom_meeting_python_sdk.pydantic.meetings_update_details_request_settings_global_dial_in_countries import MeetingsUpdateDetailsRequestSettingsGlobalDialInCountries
from zoom_meeting_python_sdk.pydantic.meetings_update_details_request_settings_global_dial_in_numbers import MeetingsUpdateDetailsRequestSettingsGlobalDialInNumbers
from zoom_meeting_python_sdk.pydantic.meetings_update_details_request_settings_language_interpretation import MeetingsUpdateDetailsRequestSettingsLanguageInterpretation
from zoom_meeting_python_sdk.pydantic.meetings_update_details_request_settings_meeting_invitees import MeetingsUpdateDetailsRequestSettingsMeetingInvitees
from zoom_meeting_python_sdk.pydantic.meetings_update_details_request_settings_resources import MeetingsUpdateDetailsRequestSettingsResources
from zoom_meeting_python_sdk.pydantic.meetings_update_details_request_settings_sign_language_interpretation import MeetingsUpdateDetailsRequestSettingsSignLanguageInterpretation

class MeetingsUpdateDetailsRequestSettings(BaseModel):
    ...
    approved_or_denied_countries_or_regions: typing.Optional[MeetingsUpdateDetailsRequestSettingsApprovedOrDeniedCountriesOrRegions] = Field(None, alias='approved_or_denied_countries_or_regions')
    ...
    authentication_exception: typing.Optional[MeetingsUpdateDetailsRequestSettingsAuthenticationException] = Field(None, alias='authentication_exception')
    ...
    breakout_room: typing.Optional[MeetingsUpdateDetailsRequestSettingsBreakoutRoom] = Field(None, alias='breakout_room')
    ...
    custom_keys: typing.Optional[MeetingsUpdateDetailsRequestSettingsCustomKeys] = Field(None, alias='custom_keys')
    ...
    global_dial_in_countries: typing.Optional[MeetingsUpdateDetailsRequestSettingsGlobalDialInCountries] = Field(None, alias='global_dial_in_countries')

    global_dial_in_numbers: typing.Optional[MeetingsUpdateDetailsRequestSettingsGlobalDialInNumbers] = Field(None, alias='global_dial_in_numbers')
    ...
    language_interpretation: typing.Optional[MeetingsUpdateDetailsRequestSettingsLanguageInterpretation] = Field(None, alias='language_interpretation')

    sign_language_interpretation: typing.Optional[MeetingsUpdateDetailsRequestSettingsSignLanguageInterpretation] = Field(None, alias='sign_language_interpretation')
    ...
    meeting_invitees: typing.Optional[MeetingsUpdateDetailsRequestSettingsMeetingInvitees] = Field(None, alias='meeting_invitees')
    ...
    continuous_meeting_chat: typing.Optional[MeetingsUpdateDetailsRequestSettingsContinuousMeetingChat] = Field(None, alias='continuous_meeting_chat')
    ...
    resources: typing.Optional[MeetingsUpdateDetailsRequestSettingsResources] = Field(None, alias='resources')
