...
from zoom_meeting_python_sdk.pydantic.reports_get_meeting_survey_report_response_survey_answers_item_answer_details import ReportsGetMeetingSurveyReportResponseSurveyAnswersItemAnswerDetails

class ReportsGetMeetingSurveyReportResponseSurveyAnswersItem(BaseModel):
    ...
    answer_details: typing.Optional[ReportsGetMeetingSurveyReportResponseSurveyAnswersItemAnswerDetails] = Field(None, alias='answer_details')
