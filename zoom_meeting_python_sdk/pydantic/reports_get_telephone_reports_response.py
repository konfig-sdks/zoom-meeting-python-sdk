...
from zoom_meeting_python_sdk.pydantic.reports_get_telephone_reports_response_telephony_usage import ReportsGetTelephoneReportsResponseTelephonyUsage

class ReportsGetTelephoneReportsResponse(BaseModel):
    ...
    telephony_usage: typing.Optional[ReportsGetTelephoneReportsResponseTelephonyUsage] = Field(None, alias='telephony_usage')
