...
from zoom_meeting_python_sdk.pydantic.meetings_get_details_response_settings_approved_or_denied_countries_or_regions import MeetingsGetDetailsResponseSettingsApprovedOrDeniedCountriesOrRegions
from zoom_meeting_python_sdk.pydantic.meetings_get_details_response_settings_authentication_exception import MeetingsGetDetailsResponseSettingsAuthenticationException
from zoom_meeting_python_sdk.pydantic.meetings_get_details_response_settings_breakout_room import MeetingsGetDetailsResponseSettingsBreakoutRoom
from zoom_meeting_python_sdk.pydantic.meetings_get_details_response_settings_continuous_meeting_chat import MeetingsGetDetailsResponseSettingsContinuousMeetingChat
from zoom_meeting_python_sdk.pydantic.meetings_get_details_response_settings_custom_keys import MeetingsGetDetailsResponseSettingsCustomKeys
from zoom_meeting_python_sdk.pydantic.meetings_get_details_response_settings_global_dial_in_countries import MeetingsGetDetailsResponseSettingsGlobalDialInCountries
from zoom_meeting_python_sdk.pydantic.meetings_get_details_response_settings_global_dial_in_numbers import MeetingsGetDetailsResponseSettingsGlobalDialInNumbers
from zoom_meeting_python_sdk.pydantic.meetings_get_details_response_settings_language_interpretation import MeetingsGetDetailsResponseSettingsLanguageInterpretation
from zoom_meeting_python_sdk.pydantic.meetings_get_details_response_settings_resources import MeetingsGetDetailsResponseSettingsResources
from zoom_meeting_python_sdk.pydantic.meetings_get_details_response_settings_sign_language_interpretation import MeetingsGetDetailsResponseSettingsSignLanguageInterpretation

class MeetingsGetDetailsResponseSettings(BaseModel):
    ...
    approved_or_denied_countries_or_regions: typing.Optional[MeetingsGetDetailsResponseSettingsApprovedOrDeniedCountriesOrRegions] = Field(None, alias='approved_or_denied_countries_or_regions')
    ...
    authentication_exception: typing.Optional[MeetingsGetDetailsResponseSettingsAuthenticationException] = Field(None, alias='authentication_exception')
    ...
    breakout_room: typing.Optional[MeetingsGetDetailsResponseSettingsBreakoutRoom] = Field(None, alias='breakout_room')
    ...
    custom_keys: typing.Optional[MeetingsGetDetailsResponseSettingsCustomKeys] = Field(None, alias='custom_keys')
    ...
    global_dial_in_countries: typing.Optional[MeetingsGetDetailsResponseSettingsGlobalDialInCountries] = Field(None, alias='global_dial_in_countries')

    global_dial_in_numbers: typing.Optional[MeetingsGetDetailsResponseSettingsGlobalDialInNumbers] = Field(None, alias='global_dial_in_numbers')
    ...
    language_interpretation: typing.Optional[MeetingsGetDetailsResponseSettingsLanguageInterpretation] = Field(None, alias='language_interpretation')

    sign_language_interpretation: typing.Optional[MeetingsGetDetailsResponseSettingsSignLanguageInterpretation] = Field(None, alias='sign_language_interpretation')
    ...
    continuous_meeting_chat: typing.Optional[MeetingsGetDetailsResponseSettingsContinuousMeetingChat] = Field(None, alias='continuous_meeting_chat')
    ...
    resources: typing.Optional[MeetingsGetDetailsResponseSettingsResources] = Field(None, alias='resources')
