...
from zoom_meeting_python_sdk.pydantic.reports_get_meeting_poll_reports_response_questions_item_question_details import ReportsGetMeetingPollReportsResponseQuestionsItemQuestionDetails

class ReportsGetMeetingPollReportsResponseQuestionsItem(BaseModel):
    ...
    question_details: typing.Optional[ReportsGetMeetingPollReportsResponseQuestionsItemQuestionDetails] = Field(None, alias='question_details')
