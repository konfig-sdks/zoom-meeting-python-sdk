...
from zoom_meeting_python_sdk.pydantic.webinars_get_survey_response_custom_survey import WebinarsGetSurveyResponseCustomSurvey

class WebinarsGetSurveyResponse(BaseModel):
    custom_survey: typing.Optional[WebinarsGetSurveyResponseCustomSurvey] = Field(None, alias='custom_survey')
