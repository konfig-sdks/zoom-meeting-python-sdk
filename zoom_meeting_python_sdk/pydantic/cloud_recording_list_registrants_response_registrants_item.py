...
from zoom_meeting_python_sdk.pydantic.cloud_recording_list_registrants_response_registrants_item_custom_questions import CloudRecordingListRegistrantsResponseRegistrantsItemCustomQuestions

class CloudRecordingListRegistrantsResponseRegistrantsItem(BaseModel):
    ...
    custom_questions: typing.Optional[CloudRecordingListRegistrantsResponseRegistrantsItemCustomQuestions] = Field(None, alias='custom_questions')
