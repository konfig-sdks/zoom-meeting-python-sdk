...
from zoom_meeting_python_sdk.pydantic.webinars_create_poll_response_questions_item_answers import WebinarsCreatePollResponseQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.webinars_create_poll_response_questions_item_prompts import WebinarsCreatePollResponseQuestionsItemPrompts
from zoom_meeting_python_sdk.pydantic.webinars_create_poll_response_questions_item_right_answers import WebinarsCreatePollResponseQuestionsItemRightAnswers

class WebinarsCreatePollResponseQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[WebinarsCreatePollResponseQuestionsItemAnswers] = Field(None, alias='answers')
    ...
    prompts: typing.Optional[WebinarsCreatePollResponseQuestionsItemPrompts] = Field(None, alias='prompts')
    ...
    right_answers: typing.Optional[WebinarsCreatePollResponseQuestionsItemRightAnswers] = Field(None, alias='right_answers')
