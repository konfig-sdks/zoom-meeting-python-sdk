...
from zoom_meeting_python_sdk.pydantic.meetings_get_poll_response_questions_item_answers import MeetingsGetPollResponseQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.meetings_get_poll_response_questions_item_prompts import MeetingsGetPollResponseQuestionsItemPrompts
from zoom_meeting_python_sdk.pydantic.meetings_get_poll_response_questions_item_right_answers import MeetingsGetPollResponseQuestionsItemRightAnswers

class MeetingsGetPollResponseQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[MeetingsGetPollResponseQuestionsItemAnswers] = Field(None, alias='answers')
    ...
    prompts: typing.Optional[MeetingsGetPollResponseQuestionsItemPrompts] = Field(None, alias='prompts')
    ...
    right_answers: typing.Optional[MeetingsGetPollResponseQuestionsItemRightAnswers] = Field(None, alias='right_answers')
