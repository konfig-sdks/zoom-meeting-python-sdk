...
from zoom_meeting_python_sdk.pydantic.meetings_get_meeting_survey_response_custom_survey_questions_item_answers import MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.meetings_get_meeting_survey_response_custom_survey_questions_item_prompts import MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItemPrompts

class MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItemAnswers] = Field(None, alias='answers')

    prompts: typing.Optional[MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsItemPrompts] = Field(None, alias='prompts')
