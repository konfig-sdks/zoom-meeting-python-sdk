...
from zoom_meeting_python_sdk.pydantic.meetings_list_past_meeting_qa_response_questions_item_question_details import MeetingsListPastMeetingQaResponseQuestionsItemQuestionDetails

class MeetingsListPastMeetingQaResponseQuestionsItem(BaseModel):
    ...
    question_details: typing.Optional[MeetingsListPastMeetingQaResponseQuestionsItemQuestionDetails] = Field(None, alias='question_details')
