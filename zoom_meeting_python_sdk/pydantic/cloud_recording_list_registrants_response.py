...
from zoom_meeting_python_sdk.pydantic.cloud_recording_list_registrants_response_registrants import CloudRecordingListRegistrantsResponseRegistrants

class CloudRecordingListRegistrantsResponse(BaseModel):
    ...
    registrants: typing.Optional[CloudRecordingListRegistrantsResponseRegistrants] = Field(None, alias='registrants')
