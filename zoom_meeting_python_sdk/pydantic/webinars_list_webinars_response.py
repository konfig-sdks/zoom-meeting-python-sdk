...
from zoom_meeting_python_sdk.pydantic.webinars_list_webinars_response_webinars import WebinarsListWebinarsResponseWebinars

class WebinarsListWebinarsResponse(BaseModel):
    ...
    webinars: typing.Optional[WebinarsListWebinarsResponseWebinars] = Field(None, alias='webinars')
