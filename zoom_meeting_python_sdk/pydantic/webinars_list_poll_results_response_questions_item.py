...
from zoom_meeting_python_sdk.pydantic.webinars_list_poll_results_response_questions_item_question_details import WebinarsListPollResultsResponseQuestionsItemQuestionDetails

class WebinarsListPollResultsResponseQuestionsItem(BaseModel):
    ...
    question_details: typing.Optional[WebinarsListPollResultsResponseQuestionsItemQuestionDetails] = Field(None, alias='question_details')
