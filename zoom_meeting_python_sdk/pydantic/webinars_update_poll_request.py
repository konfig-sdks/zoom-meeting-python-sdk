...
from zoom_meeting_python_sdk.pydantic.webinars_update_poll_request_questions import WebinarsUpdatePollRequestQuestions

class WebinarsUpdatePollRequest(BaseModel):
    ...
    questions: typing.Optional[WebinarsUpdatePollRequestQuestions] = Field(None, alias='questions')
