...
from zoom_meeting_python_sdk.pydantic.meetings_update_meeting_poll_request_questions import MeetingsUpdateMeetingPollRequestQuestions

class MeetingsUpdateMeetingPollRequest(BaseModel):
    ...
    questions: typing.Optional[MeetingsUpdateMeetingPollRequestQuestions] = Field(None, alias='questions')
