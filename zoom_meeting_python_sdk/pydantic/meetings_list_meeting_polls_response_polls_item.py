...
from zoom_meeting_python_sdk.pydantic.meetings_list_meeting_polls_response_polls_item_questions import MeetingsListMeetingPollsResponsePollsItemQuestions

class MeetingsListMeetingPollsResponsePollsItem(BaseModel):
    ...
    questions: typing.Optional[MeetingsListMeetingPollsResponsePollsItemQuestions] = Field(None, alias='questions')
