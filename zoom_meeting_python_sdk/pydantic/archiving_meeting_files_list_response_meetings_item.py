...
from zoom_meeting_python_sdk.pydantic.archiving_meeting_files_list_response_meetings_item_archive_files import ArchivingMeetingFilesListResponseMeetingsItemArchiveFiles

class ArchivingMeetingFilesListResponseMeetingsItem(BaseModel):
    # The user's account name.
    account_name: str = Field(alias='account_name')

    archive_files: ArchivingMeetingFilesListResponseMeetingsItemArchiveFiles = Field(alias='archive_files')
