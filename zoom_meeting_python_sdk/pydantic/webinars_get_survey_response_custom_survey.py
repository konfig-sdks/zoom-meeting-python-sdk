...
from zoom_meeting_python_sdk.pydantic.webinars_get_survey_response_custom_survey_questions import WebinarsGetSurveyResponseCustomSurveyQuestions

class WebinarsGetSurveyResponseCustomSurvey(BaseModel):
    ...
    questions: typing.Optional[WebinarsGetSurveyResponseCustomSurveyQuestions] = Field(None, alias='questions')
