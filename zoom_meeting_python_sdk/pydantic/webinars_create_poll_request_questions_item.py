...
from zoom_meeting_python_sdk.pydantic.webinars_create_poll_request_questions_item_answers import WebinarsCreatePollRequestQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.webinars_create_poll_request_questions_item_prompts import WebinarsCreatePollRequestQuestionsItemPrompts
from zoom_meeting_python_sdk.pydantic.webinars_create_poll_request_questions_item_right_answers import WebinarsCreatePollRequestQuestionsItemRightAnswers

class WebinarsCreatePollRequestQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[WebinarsCreatePollRequestQuestionsItemAnswers] = Field(None, alias='answers')
    ...
    prompts: typing.Optional[WebinarsCreatePollRequestQuestionsItemPrompts] = Field(None, alias='prompts')
    ...
    right_answers: typing.Optional[WebinarsCreatePollRequestQuestionsItemRightAnswers] = Field(None, alias='right_answers')
