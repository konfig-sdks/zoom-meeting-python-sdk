...
from zoom_meeting_python_sdk.pydantic.meetings_create_poll_response_questions_item_answers import MeetingsCreatePollResponseQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.meetings_create_poll_response_questions_item_prompts import MeetingsCreatePollResponseQuestionsItemPrompts
from zoom_meeting_python_sdk.pydantic.meetings_create_poll_response_questions_item_right_answers import MeetingsCreatePollResponseQuestionsItemRightAnswers

class MeetingsCreatePollResponseQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[MeetingsCreatePollResponseQuestionsItemAnswers] = Field(None, alias='answers')
    ...
    prompts: typing.Optional[MeetingsCreatePollResponseQuestionsItemPrompts] = Field(None, alias='prompts')
    ...
    right_answers: typing.Optional[MeetingsCreatePollResponseQuestionsItemRightAnswers] = Field(None, alias='right_answers')
