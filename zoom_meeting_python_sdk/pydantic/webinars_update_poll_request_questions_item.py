...
from zoom_meeting_python_sdk.pydantic.webinars_update_poll_request_questions_item_answers import WebinarsUpdatePollRequestQuestionsItemAnswers
from zoom_meeting_python_sdk.pydantic.webinars_update_poll_request_questions_item_prompts import WebinarsUpdatePollRequestQuestionsItemPrompts
from zoom_meeting_python_sdk.pydantic.webinars_update_poll_request_questions_item_right_answers import WebinarsUpdatePollRequestQuestionsItemRightAnswers

class WebinarsUpdatePollRequestQuestionsItem(BaseModel):
    ...
    answers: typing.Optional[WebinarsUpdatePollRequestQuestionsItemAnswers] = Field(None, alias='answers')
    ...
    prompts: typing.Optional[WebinarsUpdatePollRequestQuestionsItemPrompts] = Field(None, alias='prompts')
    ...
    right_answers: typing.Optional[WebinarsUpdatePollRequestQuestionsItemRightAnswers] = Field(None, alias='right_answers')
