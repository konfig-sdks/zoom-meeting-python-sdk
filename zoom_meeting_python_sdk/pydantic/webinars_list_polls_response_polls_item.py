...
from zoom_meeting_python_sdk.pydantic.webinars_list_polls_response_polls_item_questions import WebinarsListPollsResponsePollsItemQuestions

class WebinarsListPollsResponsePollsItem(BaseModel):
    ...
    questions: typing.Optional[WebinarsListPollsResponsePollsItemQuestions] = Field(None, alias='questions')
