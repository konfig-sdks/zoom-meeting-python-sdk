...
from zoom_meeting_python_sdk.model.meetings_list_registrants_response import MeetingsListRegistrantsResponse as MeetingsListRegistrantsResponseSchema

from zoom_meeting_python_sdk.type.meetings_list_registrants_response import MeetingsListRegistrantsResponse

from ...api_client import Dictionary
from zoom_meeting_python_sdk.pydantic.meetings_list_registrants_response import MeetingsListRegistrantsResponse as MeetingsListRegistrantsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = MeetingsListRegistrantsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MeetingsListRegistrantsResponse
...
class ListRegistrants(BaseApi):
    ...
    async def alist_registrants(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MeetingsListRegistrantsResponsePydantic:
        ...
        if validate:
            return MeetingsListRegistrantsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MeetingsListRegistrantsResponsePydantic, raw_response.body)
