...
from zoom_meeting_python_sdk.model.meetings_add_registrant_request_custom_questions import MeetingsAddRegistrantRequestCustomQuestions as MeetingsAddRegistrantRequestCustomQuestionsSchema
from zoom_meeting_python_sdk.model.meetings_add_registrant_response import MeetingsAddRegistrantResponse as MeetingsAddRegistrantResponseSchema
from zoom_meeting_python_sdk.model.meetings_add_registrant_request import MeetingsAddRegistrantRequest as MeetingsAddRegistrantRequestSchema

from zoom_meeting_python_sdk.type.meetings_add_registrant_response import MeetingsAddRegistrantResponse
from zoom_meeting_python_sdk.type.meetings_add_registrant_request import MeetingsAddRegistrantRequest
...
from zoom_meeting_python_sdk.pydantic.meetings_add_registrant_response import MeetingsAddRegistrantResponse as MeetingsAddRegistrantResponsePydantic
from zoom_meeting_python_sdk.pydantic.meetings_add_registrant_request_custom_questions import MeetingsAddRegistrantRequestCustomQuestions as MeetingsAddRegistrantRequestCustomQuestionsPydantic
from zoom_meeting_python_sdk.pydantic.meetings_add_registrant_request import MeetingsAddRegistrantRequest as MeetingsAddRegistrantRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = MeetingsAddRegistrantRequestSchema


request_body_meetings_add_registrant_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = MeetingsAddRegistrantResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: MeetingsAddRegistrantResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_registrant_mapped_args(
        ...
        custom_questions: typing.Optional[MeetingsAddRegistrantRequestCustomQuestions] = None,
    ...
    async def _aadd_registrant_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/meetings/{meetingId}/registrants',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_meetings_add_registrant_request.serialize(body, content_type)
...
class AddRegistrant(BaseApi):
    ...
    async def aadd_registrant(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MeetingsAddRegistrantResponsePydantic:
        ...
        if validate:
            return MeetingsAddRegistrantResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MeetingsAddRegistrantResponsePydantic, raw_response.body)
