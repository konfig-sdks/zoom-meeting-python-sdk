...
from zoom_meeting_python_sdk.model.webinars_get_details_response import WebinarsGetDetailsResponse as WebinarsGetDetailsResponseSchema

from zoom_meeting_python_sdk.type.webinars_get_details_response import WebinarsGetDetailsResponse

from ...api_client import Dictionary
from zoom_meeting_python_sdk.pydantic.webinars_get_details_response import WebinarsGetDetailsResponse as WebinarsGetDetailsResponsePydantic

# Query params
OccurrenceIdSchema = schemas.StrSchema
ShowPreviousOccurrencesSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'show_previous_occurrences': typing.Union[ShowPreviousOccurrencesSchema, bool, ],
    },
    total=False
)
...
request_query_show_previous_occurrences = api_client.QueryParameter(
    name="show_previous_occurrences",
    style=api_client.ParameterStyle.FORM,
    schema=ShowPreviousOccurrencesSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = WebinarsGetDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebinarsGetDetailsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_details_mapped_args(
        ...
        show_previous_occurrences: typing.Optional[bool] = None,
        ...
        if show_previous_occurrences is not None:
            _query_params["show_previous_occurrences"] = show_previous_occurrences
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_show_previous_occurrences,
        ):
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebinarsGetDetailsResponsePydantic:
        ...
        if validate:
            return WebinarsGetDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebinarsGetDetailsResponsePydantic, raw_response.body)
