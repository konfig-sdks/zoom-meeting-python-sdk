...
class BaseApi(api_client.Api):
    ...
    def _delete_user_tsp_account_mapped_args(
        self,
    ...
    async def _adelete_user_tsp_account_oapg(
        self,
    ...
    def _delete_user_tsp_account_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteUserTspAccountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_user_tsp_account(
        self,
        user_id: typing.Union[str, str, str],
        tsp_id: str,
        **kwargs,
        ...
        args = self._delete_user_tsp_account_mapped_args(
            user_id=user_id,
            tsp_id=tsp_id,
        )
        return await self._adelete_user_tsp_account_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_user_tsp_account(
        self,
        user_id: typing.Union[str, str, str],
        tsp_id: str,
    ) -> typing.Union[
        ...
        return self._delete_user_tsp_account_oapg(
            path_params=args.path,
        )

class DeleteUserTspAccount(BaseApi):
    ...
    async def adelete_user_tsp_account(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_user_tsp_account(
            user_id=user_id,
            tsp_id=tsp_id,
            **kwargs,
        )
    ...
    def delete_user_tsp_account(
        ...
        raw_response = self.raw.delete_user_tsp_account(
            user_id=user_id,
            tsp_id=tsp_id,
        )
