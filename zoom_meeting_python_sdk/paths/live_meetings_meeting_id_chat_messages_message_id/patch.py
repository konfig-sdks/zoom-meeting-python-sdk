...
from zoom_meeting_python_sdk.model.meetings_update_message_request import MeetingsUpdateMessageRequest as MeetingsUpdateMessageRequestSchema

from zoom_meeting_python_sdk.type.meetings_update_message_request import MeetingsUpdateMessageRequest

from ...api_client import Dictionary
from zoom_meeting_python_sdk.pydantic.meetings_update_message_request import MeetingsUpdateMessageRequest as MeetingsUpdateMessageRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = MeetingsUpdateMessageRequestSchema


request_body_meetings_update_message_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_message_mapped_args(
        ...
        if message_content is not None:
            _body["message_content"] = message_content
        args.body = _body
    ...
    async def _aupdate_message_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_meetings_update_message_request.serialize(body, content_type)
