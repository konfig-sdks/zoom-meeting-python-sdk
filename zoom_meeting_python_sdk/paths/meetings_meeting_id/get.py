...
from zoom_meeting_python_sdk.model.meetings_get_details_response import MeetingsGetDetailsResponse as MeetingsGetDetailsResponseSchema

from zoom_meeting_python_sdk.type.meetings_get_details_response import MeetingsGetDetailsResponse

from ...api_client import Dictionary
from zoom_meeting_python_sdk.pydantic.meetings_get_details_response import MeetingsGetDetailsResponse as MeetingsGetDetailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = MeetingsGetDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MeetingsGetDetailsResponse
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MeetingsGetDetailsResponsePydantic:
        ...
        if validate:
            return MeetingsGetDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MeetingsGetDetailsResponsePydantic, raw_response.body)
