...
from zoom_meeting_python_sdk.model.webinars_list_registrants_response import WebinarsListRegistrantsResponse as WebinarsListRegistrantsResponseSchema

from zoom_meeting_python_sdk.type.webinars_list_registrants_response import WebinarsListRegistrantsResponse

from ...api_client import Dictionary
from zoom_meeting_python_sdk.pydantic.webinars_list_registrants_response import WebinarsListRegistrantsResponse as WebinarsListRegistrantsResponsePydantic
...
class StatusSchema(
    ...
    def DENIED(cls):
        return cls("denied")
TrackingSourceIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'tracking_source_id': typing.Union[TrackingSourceIdSchema, str, ],
...
request_query_tracking_source_id = api_client.QueryParameter(
    name="tracking_source_id",
    style=api_client.ParameterStyle.FORM,
    schema=TrackingSourceIdSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = WebinarsListRegistrantsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebinarsListRegistrantsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_registrants_mapped_args(
        self,
        webinar_id: int,
        occurrence_id: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        tracking_source_id: typing.Optional[str] = None,
        ...
        if tracking_source_id is not None:
            _query_params["tracking_source_id"] = tracking_source_id
    ...
    async def _alist_registrants_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_tracking_source_id,
...
class ListRegistrantsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_registrants(
        self,
        webinar_id: int,
        occurrence_id: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_registrants_mapped_args(
        ...
        return await self._alist_registrants_oapg(
    ...
    def list_registrants(
        ...
        return self._list_registrants_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListRegistrants(BaseApi):
    ...
    async def alist_registrants(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebinarsListRegistrantsResponsePydantic:
        raw_response = await self.raw.alist_registrants(
            webinar_id=webinar_id,
            occurrence_id=occurrence_id,
            status=status,
            tracking_source_id=tracking_source_id,
        ...
        if validate:
            return WebinarsListRegistrantsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebinarsListRegistrantsResponsePydantic, raw_response.body)
    ...
    def list_registrants(
        ...
        raw_response = self.raw.list_registrants(
            webinar_id=webinar_id,
            occurrence_id=occurrence_id,
            status=status,
            tracking_source_id=tracking_source_id,
