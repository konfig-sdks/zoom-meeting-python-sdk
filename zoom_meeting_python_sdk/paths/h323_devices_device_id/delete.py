...
class BaseApi(api_client.Api):
    ...
    def _delete_device_mapped_args(
        self,
        device_id: str,
    ...
    async def _adelete_device_oapg(
        self,
...
class DeleteDeviceRaw(BaseApi):
    ...
    async def adelete_device(
        ...
        **kwargs,
        ...
        args = self._delete_device_mapped_args(
            device_id=device_id,
        )
        return await self._adelete_device_oapg(
...
class DeleteDevice(BaseApi):
    ...
    async def adelete_device(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_device(
            device_id=device_id,
            **kwargs,
        )
    ...
    def delete_device(
        ...
        raw_response = self.raw.delete_device(
            device_id=device_id,
        )
