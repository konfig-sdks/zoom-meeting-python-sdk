...
class BaseApi(api_client.Api):
    ...
    def _remove_panelists_mapped_args(
        self,
        webinar_id: int,
    ...
    async def _aremove_panelists_oapg(
        self,
...
class RemovePanelistsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_panelists(
        self,
        webinar_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_panelists_mapped_args(
            webinar_id=webinar_id,
        )
        return await self._aremove_panelists_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_panelists(
        self,
        webinar_id: int,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._remove_panelists_oapg(
            path_params=args.path,
        )

class RemovePanelists(BaseApi):
    ...
    async def aremove_panelists(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_panelists(
            webinar_id=webinar_id,
            **kwargs,
        )
    ...
    def remove_panelists(
        ...
        raw_response = self.raw.remove_panelists(
            webinar_id=webinar_id,
        )
