...
from zoom_meeting_python_sdk.model.webinars_update_status_request import WebinarsUpdateStatusRequest as WebinarsUpdateStatusRequestSchema

from zoom_meeting_python_sdk.type.webinars_update_status_request import WebinarsUpdateStatusRequest

from ...api_client import Dictionary
from zoom_meeting_python_sdk.pydantic.webinars_update_status_request import WebinarsUpdateStatusRequest as WebinarsUpdateStatusRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = WebinarsUpdateStatusRequestSchema


request_body_webinars_update_status_request = api_client.RequestBody(
    content={
    ...
    async def _aupdate_status_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/webinars/{webinarId}/status',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_webinars_update_status_request.serialize(body, content_type)
