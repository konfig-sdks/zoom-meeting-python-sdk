...
class BaseApi(api_client.Api):
    ...
    def _delete_survey_mapped_args(
        self,
        webinar_id: int,
    ...
    async def _adelete_survey_oapg(
        self,
...
class DeleteSurveyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_survey(
        self,
        webinar_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_survey_mapped_args(
            webinar_id=webinar_id,
        )
        return await self._adelete_survey_oapg(
    ...
    def delete_survey(
        ...
        return self._delete_survey_oapg(
            path_params=args.path,
        )

class DeleteSurvey(BaseApi):
    ...
    async def adelete_survey(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_survey(
            webinar_id=webinar_id,
            **kwargs,
        )
    ...
    def delete_survey(
        ...
        raw_response = self.raw.delete_survey(
            webinar_id=webinar_id,
        )
