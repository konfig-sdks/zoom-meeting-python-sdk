...
class DeleteFieldRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_field(
        self,
        field_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_field_mapped_args(
            field_id=field_id,
        )
        return await self._adelete_field_oapg(
    ...
    def delete_field(
        ...
        return self._delete_field_oapg(
            path_params=args.path,
        )

class DeleteField(BaseApi):
    ...
    async def adelete_field(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_field(
            field_id=field_id,
            **kwargs,
        )
    ...
    def delete_field(
        ...
        raw_response = self.raw.delete_field(
            field_id=field_id,
        )
