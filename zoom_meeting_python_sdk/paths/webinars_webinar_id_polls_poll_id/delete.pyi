...
class DeletePollRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_poll(
        self,
        webinar_id: int,
        poll_id: str,
        **kwargs,
        ...
        args = self._delete_poll_mapped_args(
            webinar_id=webinar_id,
            poll_id=poll_id,
        )
        return await self._adelete_poll_oapg(
    ...
    def delete_poll(
        ...
        return self._delete_poll_oapg(
            path_params=args.path,
        )

class DeletePoll(BaseApi):
    ...
    async def adelete_poll(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_poll(
            webinar_id=webinar_id,
            poll_id=poll_id,
            **kwargs,
        )
    ...
    def delete_poll(
        ...
        raw_response = self.raw.delete_poll(
            webinar_id=webinar_id,
            poll_id=poll_id,
        )
