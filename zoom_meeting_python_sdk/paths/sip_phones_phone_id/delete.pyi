...
class DeletePhoneRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_phone(
        self,
        phone_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_phone_mapped_args(
            phone_id=phone_id,
        )
        return await self._adelete_phone_oapg(
    ...
    def delete_phone(
        ...
        return self._delete_phone_oapg(
            path_params=args.path,
        )

class DeletePhone(BaseApi):
    ...
    async def adelete_phone(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_phone(
            phone_id=phone_id,
            **kwargs,
        )
    ...
    def delete_phone(
        ...
        raw_response = self.raw.delete_phone(
            phone_id=phone_id,
        )
