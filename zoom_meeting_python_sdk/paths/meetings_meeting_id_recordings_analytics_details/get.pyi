...
from zoom_meeting_python_sdk.model.analytics_details_response import AnalyticsDetailsResponse as AnalyticsDetailsResponseSchema

from zoom_meeting_python_sdk.type.analytics_details_response import AnalyticsDetailsResponse

from ...api_client import Dictionary
from zoom_meeting_python_sdk.pydantic.analytics_details_response import AnalyticsDetailsResponse as AnalyticsDetailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AnalyticsDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AnalyticsDetailsResponse
    ...
    async def _adetails_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/meetings/{meetingId}/recordings/analytics_details',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Details(BaseApi):
    ...
    async def adetails(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AnalyticsDetailsResponsePydantic:
        ...
        if validate:
            return AnalyticsDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AnalyticsDetailsResponsePydantic, raw_response.body)
