...
class BaseApi(api_client.Api):
    ...
    def _delete_recording_mapped_args(
        self,
        meeting_id: str,
        recording_id: str,
    ...
    async def _adelete_recording_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/meetings/{meetingId}/recordings/{recordingId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeleteRecordingRaw(BaseApi):
    ...
    async def adelete_recording(
        ...
        **kwargs,
        ...
        args = self._delete_recording_mapped_args(
            meeting_id=meeting_id,
            recording_id=recording_id,
            action=action,
        )
        return await self._adelete_recording_oapg(
    ...
    def delete_recording(
        ...
        return self._delete_recording_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeleteRecording(BaseApi):
    ...
    async def adelete_recording(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_recording(
            meeting_id=meeting_id,
            recording_id=recording_id,
            action=action,
            **kwargs,
    ...
    def delete_recording(
        ...
        raw_response = self.raw.delete_recording(
            meeting_id=meeting_id,
            recording_id=recording_id,
            action=action,
        )
