...
class BaseApi(api_client.Api):
    ...
    def _delete_meeting_recordings_mapped_args(
        self,
        meeting_id: str,
    ...
    async def _adelete_meeting_recordings_oapg(
        self,
    ...
    def _delete_meeting_recordings_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeleteMeetingRecordingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_meeting_recordings(
        self,
        meeting_id: str,
        action: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._delete_meeting_recordings_mapped_args(
            meeting_id=meeting_id,
            action=action,
        )
        return await self._adelete_meeting_recordings_oapg(
    ...
    def delete_meeting_recordings(
        ...
        return self._delete_meeting_recordings_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeleteMeetingRecordings(BaseApi):
    ...
    async def adelete_meeting_recordings(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_meeting_recordings(
            meeting_id=meeting_id,
            action=action,
            **kwargs,
        )
    ...
    def delete_meeting_recordings(
        ...
        raw_response = self.raw.delete_meeting_recordings(
            meeting_id=meeting_id,
            action=action,
        )
