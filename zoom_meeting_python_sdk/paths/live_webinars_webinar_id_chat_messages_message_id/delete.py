...
class BaseApi(api_client.Api):
    ...
    def _delete_message_by_id_mapped_args(
        self,
        webinar_id: int,
        message_id: str,
    ...
    async def _adelete_message_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/live_webinars/{webinarId}/chat/messages/{messageId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _delete_message_by_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeleteMessageByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_message_by_id(
        self,
        webinar_id: int,
        message_id: str,
        file_ids: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._delete_message_by_id_mapped_args(
            webinar_id=webinar_id,
            message_id=message_id,
            file_ids=file_ids,
        )
        return await self._adelete_message_by_id_oapg(
    ...
    def delete_message_by_id(
        ...
        return self._delete_message_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeleteMessageById(BaseApi):
    ...
    async def adelete_message_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_message_by_id(
            webinar_id=webinar_id,
            message_id=message_id,
            file_ids=file_ids,
            **kwargs,
    ...
    def delete_message_by_id(
        ...
        raw_response = self.raw.delete_message_by_id(
            webinar_id=webinar_id,
            message_id=message_id,
            file_ids=file_ids,
        )
