...
class PollDeleteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apoll_delete(
        self,
        meeting_id: int,
        poll_id: str,
        **kwargs,
        ...
        args = self._poll_delete_mapped_args(
            meeting_id=meeting_id,
            poll_id=poll_id,
        )
        return await self._apoll_delete_oapg(
    ...
    def poll_delete(
        ...
        return self._poll_delete_oapg(
            path_params=args.path,
        )

class PollDelete(BaseApi):
    ...
    async def apoll_delete(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apoll_delete(
            meeting_id=meeting_id,
            poll_id=poll_id,
            **kwargs,
        )
    ...
    def poll_delete(
        ...
        raw_response = self.raw.poll_delete(
            meeting_id=meeting_id,
            poll_id=poll_id,
        )
